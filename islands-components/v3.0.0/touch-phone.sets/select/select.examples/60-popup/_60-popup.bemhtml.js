var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $446(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg14'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg13'], __$ctx['__$anflg13'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $446(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg13'] = __r0, '', __r4;
        return;
    }
    function $17(__$ctx) {
    ...
    function $21(__$ctx) {
        var _$2jctx = __$ctx.ctx, _$2jselectMods = __$ctx._formSelect.mods, _$2jtabindex = __$ctx._formSelect.tabindex, _$2jm = _$2jctx.mods || {};
        _$2jm.arrow = 'down';
        _$2jselectMods.theme && (_$2jm.theme = _$2jselectMods.theme);
        _$2jselectMods.size && (_$2jm.size = _$2jselectMods.size);
        _$2jselectMods.disabled === 'yes' && (_$2jm.disabled = 'yes');
        _$2jctx.mods = _$2jm;
        _$2jtabindex && (_$2jctx.tabindex = _$2jtabindex);
        {
            '';
    ...
    function $37(__$ctx) {
        var _$2actx = __$ctx.ctx, _$2aid = _$2actx.id || __$ctx.generateId();
        {
            '';
            ...
            __$ctx['__$anflg10'] = true;
            {
                ...
                __$ctx._controlAttrs = {
                    id: _$2aid,
                    name: _$2actx.name || _$2aid,
                    tabindex: _$2actx.tabindex
                };
    ...
    function $52(__$ctx) {
        ...
        if (__t === 'select') {
            ...
            if (__t === 'control') {
                ...
                while (_$2mp = _$2mattrs.pop()) {
                    __$ctx._controlAttrs[_$2mp] && (_$2mprop[_$2mp] = __$ctx._controlAttrs[_$2mp]);
                }
                $$mods.disabled === 'yes' && (_$2mprop.disabled = 'disabled');
                _$2mprop.tabindex = -1;
                _$2mprop['aria-hidden'] = true;
                return __$ctx.ctx.controlAttrs || _$2mprop;
                return;
            } else if (__t === 'item') {
                return $56(__$ctx);
            } else {
    ...
    function $56(__$ctx) {
        if (!(__$ctx['__$anflg11'] !== true) === false) {
            var __r0, __r1;
            var _$2ha = ('', __r0 = __$ctx['__$anflg11'], __$ctx['__$anflg11'] = true, __r1 = $56(__$ctx), __$ctx['__$anflg11'] = __r0, '', __r1) || {};
            if ((__$ctx.ctx.elemMods || {}).label === 'yes') {
                _$2ha.id = __$ctx._labelId;
    ...
    function $69(__$ctx) {
        if (!(__$ctx['__$anflg9'] !== true) === false) {
            if (!__$ctx.ctx.url === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$28ctx = __$ctx.ctx, _$28p = ('', __r0 = __$ctx['__$anflg9'], __$ctx['__$anflg9'] = true, __r1 = $63(__$ctx), __$ctx['__$anflg9'] = __r0, '', __r1), _$28a = { href: _$28ctx.url };
    ...
    function $82(__$ctx) {
        var __r0, __r1;
        var _$27ctx = __$ctx.ctx, _$27p = ('', __r0 = __$ctx['__$anflg8'], __$ctx['__$anflg8'] = true, __r1 = $63(__$ctx), __$ctx['__$anflg8'] = __r0, '', __r1), _$27a = { type: _$27ctx.type || 'button' }, _$27props = [
                'name',
                'value'
            ], _$27i;
    ...
    function $189(__$ctx) {
        if (!(__$ctx['__$anflg2'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$jc = ('', __r0 = __$ctx['__$anflg2'], __$ctx['__$anflg2'] = true, __r1 = $189(__$ctx), __$ctx['__$anflg2'] = __r0, '', __r1);
                _$jc += [
    ...
    function $203(__$ctx) {
        if (!($$mods && $$mods.pseudo === 'yes') === false) {
            if (!!$$elem === false) {
                if (!!__$ctx.ctx.url === false) {
                    var _$1wdisabled = (__$ctx.ctx.mods || {}).disabled === 'yes', _$1wa = {
                            role: 'button',
                            tabindex: 0
                        };
                    if (_$1wdisabled) {
                        _$1wa['aria-disabled'] = true;
                        delete _$1wa.tabindex;
                    } else {
                        undefined;
                    }
                    return _$1wa;
    ...
    function $212(__$ctx) {
        if (!(__$ctx['__$anflg5'] !== true) === false) {
            if (!($$mods && $$mods.disabled === 'yes') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$1sattrs = ('', __r0 = __$ctx['__$anflg5'], __$ctx['__$anflg5'] = true, __r1 = $203(__$ctx), __$ctx['__$anflg5'] = __r0, '', __r1) || {};
                    _$1sattrs.tabindex = -1;
                    _$1sattrs['aria-disabled'] = true;
                    return _$1sattrs;
                    return;
                } else {
                    return $221(__$ctx);
    ...
    function $223(__$ctx) {
        var _$1rctx = __$ctx.ctx, _$1rattrs = {};
        [
            'title',
            'target',
            'id',
            ...
            if (_$1rctx.hasOwnProperty(param)) {
                _$1rattrs[param] = String(_$1rctx[param]);
            } else {
                undefined;
            }
        });
        if (_$1rctx.url !== null && typeof _$1rctx.url !== 'undefined') {
            if (__$ctx.isSimple(_$1rctx.url)) {
                _$1rattrs.href = String(_$1rctx.url);
            } else {
                var _$1rbuf = [];
                {
                    '';
                ...
                undefined;
                _$1rattrs.href = _$1rbuf.join('');
            }
        } else {
            _$1rattrs.role = 'button';
            if (!_$1rattrs.tabindex) {
                _$1rattrs.tabindex = '0';
            } else {
                undefined;
            }
        }
    ...
    function $257(__$ctx) {
        if (!(__$ctx['__$anflg6'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1umix = ('', __r0 = __$ctx['__$anflg6'], __$ctx['__$anflg6'] = true, __r1 = $257(__$ctx), __$ctx['__$anflg6'] = __r0, '', __r1) || [];
                _$1umix.push({
    ...
    function $268(__$ctx) {
        ...
        var _$1omix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $266(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1ojsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $$elem, $$elem = '', __r5 = $423(__$ctx), $$mode = __r3, $$elem = __r4, '', __r5);
    ...
    function $271(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1mmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $265(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1mmix.push({
                    block: 'i-ua',
                ...
                __$ctx.ctx = {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            ].concat(('', __r1 = $$mode, $$mode = 'mix', __r2 = $265(__$ctx), $$mode = __r1, '', __r2) || [], __$ctx.ctx.mix || []),
                            content: __$ctx.ctx.content
                        }
                    ]
                };
    ...
    function $374(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $446(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $407(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $446(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg1'] = __r0, '', __r4;
        return;
    }
    function $421(__$ctx) {
        return undefined;
    ...
    function $425(__$ctx) {
        ...
        for (_$ye in _$y_this) {
            if (_$y_this.hasOwnProperty(_$ye) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ye, __r3 = $431(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $448(__$ctx) {
        ...
        while (_$ke = _$kes.shift()) {
            _$kps[_$ke] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ke, __r3 = $377(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$kps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $439(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $473(__$ctx) {
        ...
        if (_$4tag) {
            ...
            _$4buf.push('<', _$4tag);
            var _$4isBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $167(__$ctx), $$mode = __r6, '', __r7);
            typeof _$4isBEM != 'undefined' || (_$4isBEM = typeof _$4v.bem != 'undefined' ? _$4v.bem : _$4v.block || _$4v.elem);
            var _$4cls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $167(__$ctx), $$mode = __r8, '', __r9);
            ...
            if (_$4jsParams) {
                var _$4jsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $167(__$ctx), $$mode = __r20, '', __r21);
                _$4buf.push(' ', _$4jsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$4jsParams)), '"');
            } else {
                undefined;
            }
            var _$4attrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $52(__$ctx), $$mode = __r22, '', __r23);
        ...
        if (__$ctx._.isShortTag(_$4tag)) {
            ...
            _$4tag && _$4buf.push('>');
            var _$4content = ('', __r24 = $$mode, $$mode = 'content', __r25 = $154(__$ctx), $$mode = __r24, '', __r25);
