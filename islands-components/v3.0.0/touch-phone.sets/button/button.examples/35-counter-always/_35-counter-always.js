...
;
/* ../../../../common.blocks/button/_counter/button_counter_yes.js begin */
(function(Lego) {

    var random = (Math.floor((Math.random() * 100)));

    /**
     * Кнопка со счетчиком кликов.
     *
     * Для учета кликов по кнопке использует глобальный объект `Lego` (блок `i-counter`).
     * По умолчанию вероятность срабатывания счётчика — 10%. Вероятностью срабатывания
     * счётчика для конкретной ссылки управляет атрибут `show-counter`.
     * При `show-counter` = 100 — срабатывание счетчика гарантировано всегда.
     *
     * @param {Number} [params.show-counter=10]  Вероятность срабатывания счетчика кликов при клике на кнопке.
     */
...
/* ../../../../common.blocks/button/_counter/button_counter_yes.js end */
;
