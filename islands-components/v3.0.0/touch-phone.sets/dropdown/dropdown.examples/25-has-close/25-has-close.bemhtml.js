var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $352(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg11'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg10'], __$ctx['__$anflg10'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $352(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg10'] = __r0, '', __r4;
        return;
    }
    function $17(__$ctx) {
        if (!(__$ctx['__$anflg7'] !== true) === false) {
            if (!($$mods && $$mods['has-close'] === 'yes') === false) {
                if (!!$$elem === false) {
                    __$ctx.ctx.content.push({ elem: 'close' });
                    {
                        '';
        ...
        if (!($$mods && $$mods.pseudo === 'yes') === false) {
            if (!!$$elem === false) {
                if (!!__$ctx.ctx.url === false) {
                    var _$26disabled = (__$ctx.ctx.mods || {}).disabled === 'yes', _$26a = {
                            role: 'button',
                            tabindex: 0
                        };
                    if (_$26disabled) {
                        _$26a['aria-disabled'] = true;
                        delete _$26a.tabindex;
                    } else {
                        undefined;
                    }
                    return _$26a;
    ...
    function $68(__$ctx) {
        if (!(__$ctx['__$anflg8'] !== true) === false) {
            if (!($$mods && $$mods.disabled === 'yes') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$22attrs = ('', __r0 = __$ctx['__$anflg8'], __$ctx['__$anflg8'] = true, __r1 = $59(__$ctx), __$ctx['__$anflg8'] = __r0, '', __r1) || {};
                    _$22attrs.tabindex = -1;
                    _$22attrs['aria-disabled'] = true;
                    return _$22attrs;
                    return;
                } else {
                    return $77(__$ctx);
    ...
    function $79(__$ctx) {
        var _$21ctx = __$ctx.ctx, _$21attrs = {};
        [
            'title',
            'target',
            'id',
            ...
            if (_$21ctx.hasOwnProperty(param)) {
                _$21attrs[param] = String(_$21ctx[param]);
            } else {
                undefined;
            }
        });
        if (_$21ctx.url !== null && typeof _$21ctx.url !== 'undefined') {
            if (__$ctx.isSimple(_$21ctx.url)) {
                _$21attrs.href = String(_$21ctx.url);
            } else {
                var _$21buf = [];
                {
                    '';
                ...
                undefined;
                _$21attrs.href = _$21buf.join('');
            }
        } else {
            _$21attrs.role = 'button';
            if (!_$21attrs.tabindex) {
                _$21attrs.tabindex = '0';
            } else {
                undefined;
            }
        }
    ...
    function $99(__$ctx) {
        if (!(__$ctx['__$anflg9'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$24mix = ('', __r0 = __$ctx['__$anflg9'], __$ctx['__$anflg9'] = true, __r1 = $99(__$ctx), __$ctx['__$anflg9'] = __r0, '', __r1) || [];
                _$24mix.push({
                ...
                __$ctx.ctx = {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            ].concat(('', __r1 = $$mode, $$mode = 'mix', __r2 = $228(__$ctx), $$mode = __r1, '', __r2) || [], __$ctx.ctx.mix || []),
                            content: __$ctx.ctx.content
                        }
                    ]
                };
    ...
    function $182(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $352(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $215(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $352(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg1'] = __r0, '', __r4;
        return;
    }
    function $228(__$ctx) {
        if ($$elem === 'body') {
    ...
    function $231(__$ctx) {
        ...
        var _$1omix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $229(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1ojsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $$elem, $$elem = '', __r5 = $329(__$ctx), $$mode = __r3, $$elem = __r4, '', __r5);
    ...
    function $234(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1mmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $228(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1mmix.push({
                    block: 'i-ua',
    ...
    function $331(__$ctx) {
        ...
        for (_$ye in _$y_this) {
            if (_$y_this.hasOwnProperty(_$ye) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ye, __r3 = $337(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $354(__$ctx) {
        ...
        while (_$ke = _$kes.shift()) {
            _$kps[_$ke] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ke, __r3 = $185(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$kps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $345(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    function $358(__$ctx) {
        if (!(__$ctx['__$anflg2'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$jc = ('', __r0 = __$ctx['__$anflg2'], __$ctx['__$anflg2'] = true, __r1 = $358(__$ctx), __$ctx['__$anflg2'] = __r0, '', __r1);
                _$jc += [
    ...
    function $393(__$ctx) {
        ...
        if (_$4tag) {
            ...
            _$4buf.push('<', _$4tag);
            var _$4isBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $127(__$ctx), $$mode = __r6, '', __r7);
            typeof _$4isBEM != 'undefined' || (_$4isBEM = typeof _$4v.bem != 'undefined' ? _$4v.bem : _$4v.block || _$4v.elem);
            var _$4cls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $127(__$ctx), $$mode = __r8, '', __r9);
            ...
            if (_$4isBEM || _$4cls) {
                ...
                if (_$4isBEM) {
                    ...
                    var _$4mix = ('', __r10 = $$mode, $$mode = 'mix', __r11 = $98(__$ctx), $$mode = __r10, '', __r11);
                    ...
                    if (_$4mix) {
                        ...
                        for (var _$4i = 0; _$4i < _$4mix.length; _$4i++) {
                            ...
                            if (_$4hasItem && !_$4visited[_$4visitedKey(_$4block, _$4elem)]) {
                                ...
                                var _$4nestedMix = ('', __r12 = $$block, $$block = _$4block, __r13 = $$elem, $$elem = _$4elem, __r14 = $$mods, $$mods = _$4mods, __r15 = $$elemMods, $$elemMods = _$4elemMods, __r16 = $$mode, $$mode = 'mix', __r17 = $98(__$ctx), $$block = __r12, $$elem = __r13, $$mods = __r14, $$elemMods = __r15, $$mode = __r16, '', __r17);
                                if (_$4nestedMix) {
            ...
            if (_$4jsParams) {
                var _$4jsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $127(__$ctx), $$mode = __r20, '', __r21);
                _$4buf.push(' ', _$4jsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$4jsParams)), '"');
            } else {
                undefined;
            }
            var _$4attrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $58(__$ctx), $$mode = __r22, '', __r23);
        ...
        if (__$ctx._.isShortTag(_$4tag)) {
            ...
            _$4tag && _$4buf.push('>');
            var _$4content = ('', __r24 = $$mode, $$mode = 'content', __r25 = $36(__$ctx), $$mode = __r24, '', __r25);
