var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $214(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg6'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg5'], __$ctx['__$anflg5'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $214(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg5'] = __r0, '', __r4;
        return;
    }
    function $15(__$ctx) {
        if ($$elem === 'core') {
    ...
    function $18(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $214(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg2'] = __r0, '', __r4;
        return;
    }
    function $33(__$ctx) {
        var __r0, __r1, __r2, __r3, __r4, __r5, __r6, __r7;
        var _$1tdate = new Date(__$ctx.ctx.timestamp);
        return ('', __r0 = $$mode, $$mode = 'format-date', __r1 = __$ctx.ctx, __r2 = __r1.date, __r1.date = _$1tdate, __r3 = $43(__$ctx), $$mode = __r0, __r1.date = __r2, '', __r3) + ' ' + ('', __r4 = $$mode, $$mode = 'format-time', __r5 = __$ctx.ctx, __r6 = __r5.date, __r5.date = _$1tdate, __r7 = $48(__$ctx), $$mode = __r4, __r5.date = __r6, '', __r7);
        return;
    }
    function $38(__$ctx) {
        var __r10, __r0, __r2, __r3, __r8, __r9, __r11, __r1, __r12, __r13, __r14, __r15, __r16, __r17, __r18, __r19;
        var _$1sdate = new Date(__$ctx.ctx.timestamp), _$1snow = new Date(), _$1sdelta = _$1snow - _$1sdate, _$1sisFuture = _$1sdelta < 0, _$1sdateMonth = _$1sdate.getMonth(), _$1snowMonth = _$1snow.getMonth(), _$1sday = _$1sdate.getDate(), _$1stoday = _$1snow.getDate(), _$1sMS_MINUTE = 60 * 1000, _$1sMS_HOUR = 3600 * 1000, _$1sMS_DAY = 24 * 3600 * 1000;
        _$1sdelta = Math.abs(_$1sdelta);
        if (!_$1sisFuture && _$1sdelta < _$1sMS_DAY) {
            if (_$1sdelta < _$1sMS_MINUTE) {
                return BEM.I18N('human-date', 'now');
            } else {
                undefined;
            }
            var _$1sminSpan = Math.floor(_$1sdelta / _$1sMS_MINUTE);
            if (_$1sminSpan < 60) {
                return BEM.I18N('human-date', 'M', { count: _$1sminSpan });
            } else {
                undefined;
            }
            var _$1shourSpan = Math.floor(_$1sdelta / _$1sMS_HOUR);
            if (_$1shourSpan < 60) {
                return BEM.I18N('human-date', 'H', { count: _$1shourSpan });
            } else {
                undefined;
            }
            return __$ctx.ctx.showTime ? BEM.I18N('human-date', 'today-at', { time: ('', __r0 = $$mode, $$mode = 'format-time', __r1 = __$ctx.ctx, __r2 = __r1.date, __r1.date = _$1sdate, __r3 = $48(__$ctx), $$mode = __r0, __r1.date = __r2, '', __r3) }) : BEM.I18N('human-date', 'today');
        } else {
            undefined;
        }
        if (!_$1sisFuture) {
            if (_$1sday === _$1stoday - 1) {
                return __$ctx.ctx.showTime ? BEM.I18N('human-date', 'yesterday-at', { time: ('', __r8 = $$mode, $$mode = 'format-time', __r9 = __$ctx.ctx, __r10 = __r9.date, __r9.date = _$1sdate, __r11 = $48(__$ctx), $$mode = __r8, __r9.date = __r10, '', __r11) }) : BEM.I18N('human-date', 'yesterday');
            } else {
                undefined;
            }
            var _$1sdaySpan = Math.floor(_$1sdelta / _$1sMS_DAY);
            if (_$1sdaySpan < 30) {
                return BEM.I18N('human-date', 'd', { count: _$1sdaySpan });
            } else {
                undefined;
            }
        } else {
        ...
        if (_$1sisFuture && _$1sday === _$1stoday + 1) {
            return __$ctx.ctx.showTime ? BEM.I18N('human-date', 'tomorrow-at', { time: ('', __r12 = $$mode, $$mode = 'format-time', __r13 = __$ctx.ctx, __r14 = __r13.date, __r13.date = _$1sdate, __r15 = $48(__$ctx), $$mode = __r12, __r13.date = __r14, '', __r15) }) : BEM.I18N('human-date', 'tomorrow');
        } else {
            undefined;
        }
        return '', __r16 = $$mode, $$mode = 'format-date', __r17 = __$ctx.ctx, __r18 = __r17.date, __r17.date = _$1sdate, __r19 = $43(__$ctx), $$mode = __r16, __r17.date = __r18, '', __r19;
        return;
    }
    function $43(__$ctx) {
        var _$1rdate = __$ctx.ctx.date, _$1rmonthNum = _$1rdate.getMonth() + 1, _$1rnowYear = new Date().getFullYear(), _$1rmonth = BEM.I18N('i-tanker__months', 'short' + _$1rmonthNum).toLowerCase(), _$1rdateArr = [
                _$1rdate.getDate(),
                _$1rmonth
            ];
        return __$ctx.ctx.showYear || _$1rnowYear != _$1rdate.getFullYear() ? _$1rdateArr.concat(_$1rdate.getFullYear()).join(' ') : _$1rdateArr.join(' ');
        return;
    }
    function $48(__$ctx) {
        var _$1qdate = __$ctx.ctx.date;
        return [
            _$1qdate.getHours(),
            ('0' + _$1qdate.getMinutes()).slice(-2)
        ].join(':');
        return;
    }
    function $59(__$ctx) {
    ...
    function $62(__$ctx) {
        ...
        var _$1omix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $60(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1ojsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $$elem, $$elem = '', __r5 = $158(__$ctx), $$mode = __r3, $$elem = __r4, '', __r5);
    ...
    function $65(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1mmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $59(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1mmix.push({
                    block: 'i-ua',
                ...
                __$ctx.ctx = {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            ].concat(('', __r1 = $$mode, $$mode = 'mix', __r2 = $59(__$ctx), $$mode = __r1, '', __r2) || [], __$ctx.ctx.mix || []),
    ...
    function $160(__$ctx) {
        ...
        for (_$xe in _$x_this) {
            if (_$x_this.hasOwnProperty(_$xe) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$xe, __r3 = $174(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $168(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $214(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $216(__$ctx) {
        ...
        while (_$je = _$jes.shift()) {
            _$jps[_$je] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$je, __r3 = $179(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$jps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $206(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $221(__$ctx) {
        if (!(__$ctx['__$anflg1'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$ic = ('', __r0 = __$ctx['__$anflg1'], __$ctx['__$anflg1'] = true, __r1 = $221(__$ctx), __$ctx['__$anflg1'] = __r0, '', __r1);
                _$ic += [
