...
;
/* ../../../../common.blocks/radio-button/radio-button.examples/70-api.blocks/example/example.js begin */
BEM.DOM.decl('example', {

    onSetMod: {

        js: function() {
            var radioButton = this.findBlockInside('radio-button');

            BEM.blocks.button.on(this.domElem, 'leftclick tap', function() {

                    var params = this.params,
                        val = params.val,
                        getVal = params.getval,
                        uncheck = params.uncheck;

                    val && radioButton.val(val) && console.log('→ ', radioButton.val(val));
                    getVal && radioButton.val() && console.log('→ ', radioButton.val());
                    uncheck && radioButton.uncheckAll() && console.log('→ ', radioButton.uncheckAll());
...
/* ../../../../common.blocks/radio-button/radio-button.examples/70-api.blocks/example/example.js end */
;
...
;
/* ../../../../common.blocks/radio-button/radio-button.examples/70-api.blocks/radio-button/radio-button.js begin */
    ...
    onSetMod: {
        ...
        js: function() {
            ...
            this.on('change', function(e, data) {
                data.current && $('#radio-button_current').text(data.current.text());
                data.prev && $('#radio-button_prev').text(data.prev.text());
...
/* ../../../../common.blocks/radio-button/radio-button.examples/70-api.blocks/radio-button/radio-button.js end */
;
