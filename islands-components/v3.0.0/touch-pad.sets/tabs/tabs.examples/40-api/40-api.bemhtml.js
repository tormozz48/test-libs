var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $364(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg13'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg12'], __$ctx['__$anflg12'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $364(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg12'] = __r0, '', __r4;
        return;
    }
    function $15(__$ctx) {
        if ($$elem === 'core') {
    ...
    function $18(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $364(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg1'] = __r0, '', __r4;
        return;
    }
    function $23(__$ctx) {
    ...
    function $43(__$ctx) {
        var __r0, __r4, __r1, __r2, __r3;
        var _$1rctx = __$ctx.ctx, _$1relemMods = $$elemMods || {};
        if (__$ctx.isFirst()) {
            _$1relemMods.first = 'yes';
        } else {
            undefined;
        }
        var _$1rlink = {
                block: 'link',
                mods: {
                    disabled: _$1relemMods.disabled,
                    counter: $$mods.counter
                },
                mix: [{
                        block: $$block,
                        elem: _$1rctx.elem,
                        elemMods: _$1relemMods,
                        js: _$1rctx.js
                    }].concat(_$1rctx.mix),
                js: _$1rctx['link-js'] || Boolean(__$ctx._js),
                url: _$1rctx.url || '#'
            };
        [
            'content',
            ...
            if (_$1rctx[p]) {
                _$1rlink[p] = _$1rctx[p];
            } else {
                undefined;
            }
        });
        return '', __r0 = __$ctx['__$anflg6'], __$ctx['__$anflg6'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = _$1rlink, __r2 = $$mode, $$mode = '', __r3 = $364(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg6'] = __r0, '', __r4;
        return;
    }
    function $46(__$ctx) {
                ...
                __$ctx.ctx = {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            ].concat(('', __r1 = $$mode, $$mode = 'mix', __r2 = $293(__$ctx), $$mode = __r1, '', __r2) || [], __$ctx.ctx.mix || []),
    ...
    function $87(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $364(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $119(__$ctx) {
        ...
        if (__t === 'button') {
            ...
            if (!($$mods && $$mods.control === 'menu') === false) {
                if (!!$$elem === false) {
                    var _$1zctx = __$ctx.ctx, _$1zproxyMods = __$ctx.extend({}, _$1zctx.mods);
                    delete _$1zproxyMods.control;
                    return {
                        block: 'tabs-menu',
                        js: true,
                        mix: [{
    ...
    function $133(__$ctx) {
        if (!(__$ctx['__$anflg2'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$jc = ('', __r0 = __$ctx['__$anflg2'], __$ctx['__$anflg2'] = true, __r1 = $133(__$ctx), __$ctx['__$anflg2'] = __r0, '', __r1);
                _$jc += [
    ...
    function $147(__$ctx) {
        if (!(__$ctx['__$anflg11'] !== true) === false) {
            if (!__$ctx.ctx.url === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$27ctx = __$ctx.ctx, _$27p = ('', __r0 = __$ctx['__$anflg11'], __$ctx['__$anflg11'] = true, __r1 = $147(__$ctx), __$ctx['__$anflg11'] = __r0, '', __r1), _$27a = { href: _$27ctx.url };
                    _$27ctx.target && (_$27a.target = _$27ctx.target);
                    $$mods.disabled && (_$27a['aria-disabled'] = true);
    ...
    function $160(__$ctx) {
        var __r0, __r1;
        var _$26ctx = __$ctx.ctx, _$26p = ('', __r0 = __$ctx['__$anflg10'], __$ctx['__$anflg10'] = true, __r1 = $147(__$ctx), __$ctx['__$anflg10'] = __r0, '', __r1), _$26a = { type: _$26ctx.type || 'button' }, _$26props = [
                'name',
                'value'
            ], _$26i;
        ...
        $$mods.disabled && (_$26a.disabled = 'disabled');
    ...
    function $165(__$ctx) {
        if (!true === false) {
            if (!!$$elem === false) {
                var _$25ctx = __$ctx.ctx, _$25a = { role: 'button' };
    ...
    function $173(__$ctx) {
        if (!(__$ctx['__$anflg7'] !== true) === false) {
            if (!($$mods && $$mods.disabled === 'yes') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$1vattrs = ('', __r0 = __$ctx['__$anflg7'], __$ctx['__$anflg7'] = true, __r1 = $173(__$ctx), __$ctx['__$anflg7'] = __r0, '', __r1) || {};
    ...
    function $277(__$ctx) {
        if (!(__$ctx['__$anflg8'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1xmix = ('', __r0 = __$ctx['__$anflg8'], __$ctx['__$anflg8'] = true, __r1 = $277(__$ctx), __$ctx['__$anflg8'] = __r0, '', __r1) || [];
                _$1xmix.push({
    ...
    function $296(__$ctx) {
        ...
        var _$1omix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $294(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1ojsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $$elem, $$elem = '', __r5 = $341(__$ctx), $$mode = __r3, $$elem = __r4, '', __r5);
    ...
    function $299(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1mmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $293(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1mmix.push({
                    block: 'i-ua',
    ...
    function $343(__$ctx) {
        ...
        for (_$ye in _$y_this) {
            if (_$y_this.hasOwnProperty(_$ye) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ye, __r3 = $349(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $366(__$ctx) {
        ...
        while (_$ke = _$kes.shift()) {
            _$kps[_$ke] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ke, __r3 = $90(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$kps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $357(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $391(__$ctx) {
        ...
        _$4tag = ('', __r0 = $$mode, $$mode = 'tag', __r1 = $229(__$ctx), $$mode = __r0, '', __r1);
        ...
        if (_$4tag) {
            ...
            var _$4cls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $332(__$ctx), $$mode = __r8, '', __r9);
            ...
            if (_$4jsParams) {
                var _$4jsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $370(__$ctx), $$mode = __r20, '', __r21);
                _$4buf.push(' ', _$4jsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$4jsParams)), '"');
            } else {
                undefined;
            }
            var _$4attrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $146(__$ctx), $$mode = __r22, '', __r23);
        ...
        if (__$ctx._.isShortTag(_$4tag)) {
            ...
            _$4tag && _$4buf.push('>');
            var _$4content = ('', __r24 = $$mode, $$mode = 'content', __r25 = $119(__$ctx), $$mode = __r24, '', __r25);
