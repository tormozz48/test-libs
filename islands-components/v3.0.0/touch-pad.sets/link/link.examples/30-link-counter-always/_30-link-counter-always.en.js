...
;
/* ../../../../common.blocks/link/_counter/link_counter_yes.js begin */
(function(){

    var random = (Math.floor((Math.random() * 100)));

    /**
     * Ссылка со счетчиком. Используется для подсчета кликов по ссылке.
     *
    ...
    BEM.DOM.decl({name: 'link', modName: 'counter', modVal: 'yes'}, {
        ...
        _onClick: function(e) {
            ...
            random <= (this.params['show-counter'] || 10) && Lego.ch(this.params.counter, this.domElem[0]);
...
/* ../../../../common.blocks/link/_counter/link_counter_yes.js end */
;
