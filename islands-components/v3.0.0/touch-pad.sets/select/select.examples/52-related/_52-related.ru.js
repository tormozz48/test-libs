...
;
/* ../../../../common.blocks/select/select.examples/52-related.blocks/example/example.js begin */
/**
 * @require BEM
 * @require BEM.DOM
 */
    ...
    onSetMod: {
        ...
        'js': function() {
            ...
            var dataMap = {
                ...
                /** {Array<BEM.DOM>} */
                select = this.findBlocksInside('select');
            ...
            function updateCity(country) {
                ...
                sobj.val(items.attr('value')).redraw();
            }
...
/* ../../../../common.blocks/select/select.examples/52-related.blocks/example/example.js end */
;
