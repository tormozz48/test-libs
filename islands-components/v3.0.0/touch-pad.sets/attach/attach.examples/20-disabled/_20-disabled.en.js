  ...
  var cache,
    ...
    function $2(__$ctx) {
        if ($$block === 'attach') {
            if ($$elem === 'control') {
                ...
                !!__$ctx._disabled && (_$2daa.disabled = 'disabled');
                __$ctx._tabindex && (_$2daa.tabindex = __$ctx._tabindex);
                _$2daa['aria-labelledby'] = __$ctx._textId;
                return _$2daa;
                return;
            } else {
                return $9(__$ctx);
    ...
    function $40(__$ctx) {
        ...
        if (!cache || !__$ctx._cacheLog) {
            return _$2czfollow.call(__$ctx);
        } else {
            undefined;
        }
        var _$2czcontents = __$ctx._buf.slice(__$ctx._cachePos).join('');
        __$ctx._cachePos = __$ctx._buf.length;
        __$ctx._cacheLog.push(_$2czcontents, {
            log: __$ctx._localLog.slice(),
            link: __$ctx.ctx.link
        });
        var _$2czres = _$2czfollow.call(__$ctx);
        __$ctx._cachePos = __$ctx._buf.length;
        return _$2czres;
        return;
    }
    ...
    function $49(__$ctx) {
        var _$2cycached;
        function _$2cysetProperty(obj, key, value) {
            if (key.length === 0) {
                return undefined;
            } else {
                undefined;
        ...
        if (_$2cycached = cache.get(__$ctx.ctx.cache)) {
            var _$2cyoldLinks = __$ctx._links;
            if (__$ctx.ctx.links) {
                __$ctx._links = __$ctx.ctx.links;
            } else {
                undefined;
            }
            for (var _$2cyi = 0; _$2cyi < _$2cycached.log.length; _$2cyi++) {
                if (typeof _$2cycached.log[_$2cyi] === 'string') {
                    __$ctx._buf.push(_$2cycached.log[_$2cyi]);
                    continue;
                } else {
                    undefined;
                }
                var _$2cylog = _$2cycached.log[_$2cyi], _$2cyreverseLog;
                _$2cyreverseLog = _$2cylog.log.map(function (entry) {
                    return {
                        key: entry[0],
                        value: _$2cysetProperty(this, entry[0], entry[1])
                    };
                }, __$ctx).reverse();
                {
                    '';
                ...
                undefined;
                _$2cyreverseLog.forEach(function (entry) {
                    _$2cysetProperty(this, entry.key, entry.value);
                }, __$ctx);
            }
            __$ctx._links = _$2cyoldLinks;
            return _$2cycached.res;
        } else {
            undefined;
        }
        var _$2cycacheLog = [], _$2cyres;
        {
            '';
            ...
            __$ctx._cacheLog = _$2cycacheLog;
            var __r9 = __$ctx._localLog;
            __$ctx._localLog = [];
            {
                _$2cyres = $1(__$ctx);
                var _$2cytail = __$ctx._buf.slice(__$ctx._cachePos).join('');
                if (_$2cytail) {
                    _$2cycacheLog.push(_$2cytail);
                } else {
                    undefined;
                }
            }
    ...
    function $54(__$ctx) {
        ...
        if (__t === 'default') {
            ...
            if (!__$ctx._.isSimple(__$ctx.ctx) === false) {
                __$ctx._listLength--;
                var _$2cwctx = __$ctx.ctx;
                (_$2cwctx && _$2cwctx !== true || _$2cwctx === 0) && __$ctx._buf.push(_$2cwctx);
                return;
            } else {
                if (!!__$ctx.ctx === false) {
                    __$ctx._listLength--;
    ...
    function $56(__$ctx) {
        ...
        var _$2cxBEM_ = __$ctx.BEM, _$2cxv = __$ctx.ctx, _$2cxbuf = __$ctx._buf, _$2cxtag;
        _$2cxtag = ('', __r0 = $$mode, $$mode = 'tag', __r1 = $10(__$ctx), $$mode = __r0, '', __r1);
        typeof _$2cxtag != 'undefined' || (_$2cxtag = _$2cxv.tag);
        typeof _$2cxtag != 'undefined' || (_$2cxtag = 'div');
        if (_$2cxtag) {
            var _$2cxjsParams, _$2cxjs;
            if ($$block && _$2cxv.js !== false) {
                _$2cxjs = ('', __r4 = $$mode, $$mode = 'js', __r5 = $33(__$ctx), $$mode = __r4, '', __r5);
                _$2cxjs = _$2cxjs ? __$ctx._.extend(_$2cxv.js, _$2cxjs === true ? {} : _$2cxjs) : _$2cxv.js === true ? {} : _$2cxv.js;
                _$2cxjs && ((_$2cxjsParams = {})[_$2cxBEM_.INTERNAL.buildClass($$block, _$2cxv.elem)] = _$2cxjs);
            } else {
                undefined;
            }
            _$2cxbuf.push('<', _$2cxtag);
            var _$2cxisBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $29(__$ctx), $$mode = __r6, '', __r7);
            typeof _$2cxisBEM != 'undefined' || (_$2cxisBEM = typeof _$2cxv.bem != 'undefined' ? _$2cxv.bem : _$2cxv.block || _$2cxv.elem);
            var _$2cxcls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $35(__$ctx), $$mode = __r8, '', __r9);
            _$2cxcls || (_$2cxcls = _$2cxv.cls);
            var _$2cxaddJSInitClass = _$2cxv.block && _$2cxjsParams;
            if (_$2cxisBEM || _$2cxcls) {
                _$2cxbuf.push(' class="');
                if (_$2cxisBEM) {
                    _$2cxBEM_.INTERNAL.buildClasses($$block, _$2cxv.elem, _$2cxv.elemMods || _$2cxv.mods, _$2cxbuf);
                    var _$2cxmix = ('', __r10 = $$mode, $$mode = 'mix', __r11 = $18(__$ctx), $$mode = __r10, '', __r11);
                    _$2cxv.mix && (_$2cxmix = _$2cxmix ? _$2cxmix.concat(_$2cxv.mix) : _$2cxv.mix);
                    if (_$2cxmix) {
                        var _$2cxvisited = {};
                        function _$2cxvisitedKey(block, elem) {
                            return (block || '') + '__' + (elem || '');
                        }
                        _$2cxvisited[_$2cxvisitedKey($$block, $$elem)] = true;
                        if (!__$ctx._.isArray(_$2cxmix)) {
                            _$2cxmix = [_$2cxmix];
                        } else {
                            undefined;
                        }
                        for (var _$2cxi = 0; _$2cxi < _$2cxmix.length; _$2cxi++) {
                            var _$2cxmixItem = _$2cxmix[_$2cxi];
                            if (!_$2cxmixItem) {
                                continue;
                            } else {
                                undefined;
                            }
                            var _$2cxhasItem = _$2cxmixItem.block || _$2cxmixItem.elem, _$2cxblock = _$2cxmixItem.block || _$2cxmixItem._block || $$block, _$2cxelem = _$2cxmixItem.elem || _$2cxmixItem._elem || $$elem, _$2cxmods = _$2cxmixItem.mods || $$mods, _$2cxelemMods = _$2cxmixItem.elemMods || {};
                            _$2cxhasItem && _$2cxbuf.push(' ');
                            _$2cxBEM_.INTERNAL[_$2cxhasItem ? 'buildClasses' : 'buildModsClasses'](_$2cxblock, _$2cxmixItem.elem || _$2cxmixItem._elem || (_$2cxmixItem.block ? undefined : $$elem), _$2cxmixItem.elemMods || _$2cxmixItem.mods, _$2cxbuf);
                            if (_$2cxmixItem.js) {
                                (_$2cxjsParams || (_$2cxjsParams = {}))[_$2cxBEM_.INTERNAL.buildClass(_$2cxblock, _$2cxmixItem.elem)] = _$2cxmixItem.js === true ? {} : _$2cxmixItem.js;
                                _$2cxaddJSInitClass || (_$2cxaddJSInitClass = _$2cxblock && !_$2cxmixItem.elem);
                            } else {
                                undefined;
                            }
                            if (_$2cxhasItem && !_$2cxvisited[_$2cxvisitedKey(_$2cxblock, _$2cxelem)]) {
                                _$2cxvisited[_$2cxvisitedKey(_$2cxblock, _$2cxelem)] = true;
                                var _$2cxnestedMix = ('', __r12 = $$block, $$block = _$2cxblock, __r13 = $$elem, $$elem = _$2cxelem, __r14 = $$mods, $$mods = _$2cxmods, __r15 = $$elemMods, $$elemMods = _$2cxelemMods, __r16 = $$mode, $$mode = 'mix', __r17 = $18(__$ctx), $$block = __r12, $$elem = __r13, $$mods = __r14, $$elemMods = __r15, $$mode = __r16, '', __r17);
                                if (_$2cxnestedMix) {
                                    for (var _$2cxj = 0; _$2cxj < _$2cxnestedMix.length; _$2cxj++) {
                                        var _$2cxnestedItem = _$2cxnestedMix[_$2cxj];
                                        if (!_$2cxnestedItem.block && !_$2cxnestedItem.elem || !_$2cxvisited[_$2cxvisitedKey(_$2cxnestedItem.block, _$2cxnestedItem.elem)]) {
                                            _$2cxnestedItem._block = _$2cxblock;
                                            _$2cxnestedItem._elem = _$2cxelem;
                                            _$2cxmix.splice(_$2cxi + 1, 0, _$2cxnestedItem);
                                        } else {
                                            undefined;
                                        }
                                    }
                ...
                _$2cxcls && _$2cxbuf.push(_$2cxisBEM ? ' ' : '', _$2cxcls);
                _$2cxaddJSInitClass && _$2cxbuf.push(' i-bem');
                _$2cxbuf.push('"');
            } else {
                undefined;
            }
            if (_$2cxjsParams) {
                var _$2cxjsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $31(__$ctx), $$mode = __r20, '', __r21);
                _$2cxbuf.push(' ', _$2cxjsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$2cxjsParams)), '"');
            } else {
                undefined;
            }
            var _$2cxattrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $2(__$ctx), $$mode = __r22, '', __r23);
            _$2cxattrs = __$ctx._.extend(_$2cxattrs, _$2cxv.attrs);
            if (_$2cxattrs) {
                var _$2cxname;
                for (_$2cxname in _$2cxattrs) {
                    if (_$2cxattrs[_$2cxname] === undefined) {
                        continue;
                    } else {
                        undefined;
                    }
                    _$2cxbuf.push(' ', _$2cxname, '="', __$ctx._.attrEscape(_$2cxattrs[_$2cxname]), '"');
                }
            } else {
                undefined;
            }
        ...
        if (__$ctx._.isShortTag(_$2cxtag)) {
            _$2cxbuf.push('/>');
        } else {
            _$2cxtag && _$2cxbuf.push('>');
            var _$2cxcontent = ('', __r24 = $$mode, $$mode = 'content', __r25 = $27(__$ctx), $$mode = __r24, '', __r25);
            if (_$2cxcontent || _$2cxcontent === 0) {
                var _$2cxisBEM = $$block || $$elem;
                {
                    '';
                    var __r26 = __$ctx._notNewList;
                    __$ctx._notNewList = false;
                    var __r27 = __$ctx.position;
                    __$ctx.position = _$2cxisBEM ? 1 : __$ctx.position;
                    var __r28 = __$ctx._listLength;
                    __$ctx._listLength = _$2cxisBEM ? 1 : __$ctx._listLength;
                    var __r29 = __$ctx.ctx;
                    __$ctx.ctx = _$2cxcontent;
                    var __r30 = $$mode;
                    $$mode = '';
                    $36(__$ctx);
            ...
            _$2cxtag && _$2cxbuf.push('</', _$2cxtag, '>');
        }
        return;
    }
    function $65(__$ctx) {
        var _$2cuv = __$ctx.ctx, _$2cul = _$2cuv.length, _$2cui = 0, _$2cuprevPos = __$ctx.position, _$2cuprevNotNewList = __$ctx._notNewList;
        if (_$2cuprevNotNewList) {
            __$ctx._listLength += _$2cul - 1;
        } else {
            __$ctx.position = 0;
            __$ctx._listLength = _$2cul;
        }
        __$ctx._notNewList = true;
        while (_$2cui < _$2cul) {
            var _$2cunewCtx = _$2cuv[_$2cui++];
            {
                '';
                var __r0 = __$ctx.ctx;
                __$ctx.ctx = _$2cunewCtx == null ? '' : _$2cunewCtx;
                $36(__$ctx);
                __$ctx.ctx = __r0;
                '';
            }
        ...
        _$2cuprevNotNewList || (__$ctx.position = _$2cuprevPos);
        return;
    }
    function $68(__$ctx) {
        var _$2ctvBlock = __$ctx.ctx.block, _$2ctvElem = __$ctx.ctx.elem, _$2ctblock = __$ctx._currBlock || $$block;
        __$ctx.ctx || (__$ctx.ctx = {});
        {
            ...
            var __r2 = $$block;
            $$block = _$2ctvBlock || (_$2ctvElem ? _$2ctblock : undefined);
            var __r3 = __$ctx._currBlock;
            __$ctx._currBlock = _$2ctvBlock || _$2ctvElem ? undefined : _$2ctblock;
            var __r4 = $$elem;
            $$elem = __$ctx.ctx.elem;
            var __r5 = $$mods;
            $$mods = (_$2ctvBlock ? __$ctx.ctx.mods : $$mods) || {};
            var __r6 = $$elemMods;
...
BEM.DOM.decl('attach', {
    ...
    resetFile: function() {
        ...
        // button снаружи обращается к DOM ноде, которая пересоздалась
        // выше. Поэтому надо сбросить кеш у button.
        this.findBlockOn('button', 'button').dropElemCache('control');
