...
;
/* ../../../../common.blocks/dropdown/dropdown.examples/20-close-it.blocks/example/example.js begin */
BEM.DOM.decl('example', {
    onSetMod: {
        js: function() {
            ...
            this
                .findBlockInside(dropdown.elem('popup'), 'button')
                .bindTo('leftclick tap', function() {
                    dropdown.hide();
                });
        }
    }
...
/* ../../../../common.blocks/dropdown/dropdown.examples/20-close-it.blocks/example/example.js end */
;
