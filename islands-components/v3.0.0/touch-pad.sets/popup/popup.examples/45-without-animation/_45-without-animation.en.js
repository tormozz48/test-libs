...
;
/* ../../../../common.blocks/popup/popup.examples/45-without-animation.blocks/example/example.js begin */
...
/* ../../../../common.blocks/popup/popup.examples/45-without-animation.blocks/example/example.js end */
;
...
;
/* ../../../../common.blocks/popup/popup.examples/45-without-animation.blocks/popup/_animate/popup_animate_yes.js begin */
BEM.DOM.decl({
    block: 'popup',
    modName: 'animate',
    modVal: 'yes'
    ...
    afterShow: function() {
        ...
        this
            .domElem
            .css({left: position.left, top: -1 * (popupSize.height + tailOpts.height), opacity: 0})
            .stop()
            .animate({
                opacity: 1,
                top: position.top
    ...
    beforeHide: function(callback) {
        ...
        this
            ...
            .animate({
                opacity: 0,
                top: -1 * (popupSize.height + tailOpts.height)
            }, 500, callback);
    }
});

/* ../../../../common.blocks/popup/popup.examples/45-without-animation.blocks/popup/_animate/popup_animate_yes.js end */
;
