...
;
/* ../../../../common.blocks/popup/popup.examples/65-modal-scroll.blocks/example/example.js begin */
...
/* ../../../../common.blocks/popup/popup.examples/65-modal-scroll.blocks/example/example.js end */
;
...
;
/* ../../../../common.blocks/popup/_behaviour/popup_behaviour_scrollable.js begin */
/**
...
/* ../../../../common.blocks/popup/_behaviour/popup_behaviour_scrollable.js end */
;
/* ../../../../common.blocks/popup/_wrapped/popup_wrapped_yes.js begin */
BEM.DOM.decl({
    block: 'popup',
    modName: 'wrapped',
    modVal: 'yes'
...
/* ../../../../common.blocks/popup/_wrapped/popup_wrapped_yes.js end */
;
/* ../../../../common.blocks/popup/_body-scroll/popup_body-scroll_no.js begin */
(function() {
    var openedPopups = {}; // Сет для всех открытых popup_body-scroll_no
    ...
    BEM.DOM.decl({block: 'popup', modName: 'body-scroll', modVal: 'no'}, {
        ...
        onSetMod: {
            ...
            visibility: function() {
                // Изменение модификатора может быть отменено,
                // поэтому надежнее проверять его в следующем тике.
                this.afterCurrentEvent(function() {
                    // Блок может быть уничтожен, поэтому проверяем domElem.
                    if(this.domElem && this.hasMod('visibility', 'visible')) {
        ...
        /**
         * Возвращает скролл на скоуп блока.
         *
        ...
        /**
         * Убирает скролл со скоупа блока.
         *
         * https://st.yandex-team.ru/ISLCOMPONENTS-1069
         *
         * @protected
...
/* ../../../../common.blocks/popup/_body-scroll/popup_body-scroll_no.js end */
;
/* ../../../../touch-pad.blocks/popup/_body-scroll/popup_body-scroll_no.js begin */
BEM.DOM.decl({
    block: 'popup',
    modName: 'body-scroll',
    modVal: 'no'
    ...
    onSetMod: {
        ...
        'visibility': {
            'visible': function(){
                ...
                if(this._scope[0] !== this._body[0]) {
                    return; // overflow: hidden не работает только на body
                }

                /**
                 * XXX: Костыль для айпада
                 * Убирает скролл с `body`
                 */
                this._scrollState = {};

                var body = this._body,
                    top = this._scrollState.top = body.scrollTop(),
                    left = this._scrollState.left = body.scrollLeft(),
                    css = {
                        position: 'fixed',
                        // XXX: Костыль для костыля
                        // https://jira.yandex-team.ru/browse/LEGO-9367
                        left: 0,
                        right: 0
                    };
                ...
                // XXX: Костыль для исправления пробела,
                // появляющегося под пиранджой
                // http://jing.yandex-team.ru/files/corpix/2013-05-21_1412.png
                top && body.scrollTop(top);
                left && body.scrollLeft(left);
            ...
            '': function() {
                ...
                scrollState.top && body.scrollTop(scrollState.top);
                scrollState.left && body.scrollLeft(scrollState.left);
...
/* ../../../../touch-pad.blocks/popup/_body-scroll/popup_body-scroll_no.js end */
;
