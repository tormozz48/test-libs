var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $456(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg13'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg12'], __$ctx['__$anflg12'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $456(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg12'] = __r0, '', __r4;
        return;
    }
    function $17(__$ctx) {
    ...
    function $21(__$ctx) {
        var _$2nctx = __$ctx.ctx, _$2nselectMods = __$ctx._formSelect.mods, _$2ntabindex = __$ctx._formSelect.tabindex, _$2nm = _$2nctx.mods || {};
        _$2nm.arrow = 'down';
        _$2nselectMods.theme && (_$2nm.theme = _$2nselectMods.theme);
        _$2nselectMods.size && (_$2nm.size = _$2nselectMods.size);
        _$2nselectMods.disabled === 'yes' && (_$2nm.disabled = 'yes');
        _$2nctx.mods = _$2nm;
        _$2ntabindex && (_$2nctx.tabindex = _$2ntabindex);
        {
            '';
    ...
    function $26(__$ctx) {
        if (!(__$ctx['__$anflg6'] !== true) === false) {
            if (!!$$elem === false) {
                var _$29mods = __$ctx.ctx.mods || {};
                _$29mods.theme = _$29mods.theme || 'normal';
                {
                    '';
    ...
    function $37(__$ctx) {
        var _$2ectx = __$ctx.ctx, _$2eid = _$2ectx.id || __$ctx.generateId();
        {
            '';
            ...
            __$ctx['__$anflg9'] = true;
            {
                ...
                __$ctx._controlAttrs = {
                    id: _$2eid,
                    name: _$2ectx.name || _$2eid,
                    tabindex: _$2ectx.tabindex
                };
    ...
    function $52(__$ctx) {
        ...
        if (__t === 'select') {
            ...
            if (__t === 'control') {
                ...
                while (_$2qp = _$2qattrs.pop()) {
                    __$ctx._controlAttrs[_$2qp] && (_$2qprop[_$2qp] = __$ctx._controlAttrs[_$2qp]);
                }
                $$mods.disabled === 'yes' && (_$2qprop.disabled = 'disabled');
                _$2qprop.tabindex = -1;
                _$2qprop['aria-hidden'] = true;
                return __$ctx.ctx.controlAttrs || _$2qprop;
                return;
            } else if (__t === 'item') {
                return $56(__$ctx);
            } else {
    ...
    function $56(__$ctx) {
        if (!(__$ctx['__$anflg10'] !== true) === false) {
            var __r0, __r1;
            var _$2la = ('', __r0 = __$ctx['__$anflg10'], __$ctx['__$anflg10'] = true, __r1 = $56(__$ctx), __$ctx['__$anflg10'] = __r0, '', __r1) || {};
    ...
    function $69(__$ctx) {
        if (!(__$ctx['__$anflg8'] !== true) === false) {
            if (!__$ctx.ctx.url === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$2cctx = __$ctx.ctx, _$2cp = ('', __r0 = __$ctx['__$anflg8'], __$ctx['__$anflg8'] = true, __r1 = $63(__$ctx), __$ctx['__$anflg8'] = __r0, '', __r1), _$2ca = { href: _$2cctx.url };
                    _$2cctx.target && (_$2ca.target = _$2cctx.target);
                    $$mods.disabled && (_$2ca['aria-disabled'] = true);
                    return __$ctx._.extend(_$2cp, _$2ca);
                    return;
                } else {
                    return $78(__$ctx);
                }
    ...
    function $82(__$ctx) {
        var __r0, __r1;
        var _$2bctx = __$ctx.ctx, _$2bp = ('', __r0 = __$ctx['__$anflg7'], __$ctx['__$anflg7'] = true, __r1 = $63(__$ctx), __$ctx['__$anflg7'] = __r0, '', __r1), _$2ba = { type: _$2bctx.type || 'button' }, _$2bprops = [
                'name',
                'value'
            ], _$2bi;
        while (_$2bi = _$2bprops.shift()) {
            _$2bctx[_$2bi] && (_$2ba[_$2bi] = _$2bctx[_$2bi]);
        }
        $$mods.disabled && (_$2ba.disabled = 'disabled');
    ...
    function $87(__$ctx) {
        if (!true === false) {
            if (!!$$elem === false) {
                var _$2actx = __$ctx.ctx, _$2aa = { role: 'button' };
                _$2actx.tabindex && (_$2aa.tabindex = _$2actx.tabindex);
                return _$2aa;
                return;
            } else {
                return $167(__$ctx);
    ...
    function $194(__$ctx) {
        if (!(__$ctx['__$anflg1'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$xc = ('', __r0 = __$ctx['__$anflg1'], __$ctx['__$anflg1'] = true, __r1 = $194(__$ctx), __$ctx['__$anflg1'] = __r0, '', __r1);
                _$xc += [
    ...
    function $208(__$ctx) {
        if (!($$mods && $$mods.pseudo === 'yes') === false) {
            if (!!$$elem === false) {
                if (!!__$ctx.ctx.url === false) {
                    var _$20disabled = (__$ctx.ctx.mods || {}).disabled === 'yes', _$20a = {
                            role: 'button',
                            tabindex: 0
                        };
                    if (_$20disabled) {
                        _$20a['aria-disabled'] = true;
                        delete _$20a.tabindex;
                    } else {
                        undefined;
                    }
                    return _$20a;
    ...
    function $217(__$ctx) {
        if (!(__$ctx['__$anflg5'] !== true) === false) {
            if (!($$mods && $$mods.disabled === 'yes') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$1xattrs = ('', __r0 = __$ctx['__$anflg5'], __$ctx['__$anflg5'] = true, __r1 = $208(__$ctx), __$ctx['__$anflg5'] = __r0, '', __r1) || {};
                    _$1xattrs.tabindex = -1;
                    _$1xattrs['aria-disabled'] = true;
                    return _$1xattrs;
                    return;
                } else {
                    return $226(__$ctx);
    ...
    function $228(__$ctx) {
        var _$1wctx = __$ctx.ctx, _$1wattrs = {};
        [
            'title',
            'target',
            'id',
            ...
            if (_$1wctx.hasOwnProperty(param)) {
                _$1wattrs[param] = String(_$1wctx[param]);
            } else {
                undefined;
            }
        });
        if (_$1wctx.url !== null && typeof _$1wctx.url !== 'undefined') {
            if (__$ctx.isSimple(_$1wctx.url)) {
                _$1wattrs.href = String(_$1wctx.url);
            } else {
                var _$1wbuf = [];
                {
                    '';
                ...
                undefined;
                _$1wattrs.href = _$1wbuf.join('');
            }
        } else {
            _$1wattrs.role = 'button';
            if (!_$1wattrs.tabindex) {
                _$1wattrs.tabindex = '0';
            } else {
                undefined;
            }
        }
    ...
    function $341(__$ctx) {
        ...
        var _$12ctx = __$ctx.ctx, _$12dtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $427(__$ctx), $$mode = __r0, '', __r1), _$12xUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $391(__$ctx), $$mode = __r2, '', __r3), _$12buf = [
                _$12dtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $348(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $456(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $354(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $456(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg2'] = __r0, '', __r4;
        return;
    }
    function $359(__$ctx) {
        var __t = $$elem;
    ...
    function $400(__$ctx) {
        ...
        var _$1kmix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $397(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1kjsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $435(__$ctx), $$mode = __r3, '', __r4);
    ...
    function $403(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1gmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $397(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1gmix.push({
                    block: 'i-ua',
    ...
    function $435(__$ctx) {
        ...
        for (_$te in _$t_this) {
            if (_$t_this.hasOwnProperty(_$te) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$te, __r3 = $441(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $458(__$ctx) {
        ...
        while (_$fe = _$fes.shift()) {
            _$fps[_$fe] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$fe, __r3 = $359(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$fps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $449(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
