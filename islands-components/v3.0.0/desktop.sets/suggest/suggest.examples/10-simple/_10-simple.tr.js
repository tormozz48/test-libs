...
;
/* ../../../../desktop.blocks/suggest/suggest.js begin */
BEM.decl('suggest', {
    ...
    onSetMod: {
        js: function() {
            ...
            /* FF20 имеет проблему с залипающим курсор-кареткой, если
             * здесь использовать click. */
            this._control.mouseup(this._request.bind(this));
    ...
    _create: function() {
        ...
        BEM.blocks['suggest-item'].on(content, 'mouseover', function(e) {
            _this._onEnterItem(e.block);
        }).on(content, 'mouseout', function(e) {
            _this._onLeaveItem(e.block);
        }).on(content, 'mousedown', function(e) {
            _this._onItemMouseDown(e.block);
        }).on(content, 'mouseup', function(e) { /* TODO Острова 2.0: Убрать. */
            _this._onItemMouseUp(e.block);
        }).on(content, 'leftclick', function(e) {
...
/* ../../../../desktop.blocks/suggest/suggest.js end */
;
...
;
/* ../../../../desktop.blocks/suggest-item/suggest-item.js begin */
BEM.DOM.decl('suggest-item', {

/**
 * Прокси для DOM-события mouseover.
 *
 * @event suggest-item#mouseover
 * @param {$.Event} e Объект DOM-события.
 */

/**
 * Прокси для DOM-события mouseout.
 *
 * @event suggest-item#mouseout
 * @param {$.Event} e Объект DOM-события.
 */

/**
 * Прокси для DOM-события mousedown.
 *
 * @event suggest-item#mousedown
 * @param {$.Event} e Объект DOM-события.
 */

/**
 * Прокси для DOM-события mouseup.
 *
 * @event suggest-item#mouseup
 * @param {$.Event} e Объект DOM-события.
 */

/**
 * Прокси для DOM-события click.
 *
 * @event suggest-item#click
 * @param {$.Event} e Объект DOM-события.
 */
    ...
    live: function() {
        ...
        /* TODO Острова 2.0: Убрать mouseup */
        this.liveBindTo('mouseover mouseout mousedown mouseup leftclick', function(e) {
...
/* ../../../../desktop.blocks/suggest-item/suggest-item.js end */
;
