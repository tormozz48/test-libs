var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $374(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg12'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg11'], __$ctx['__$anflg11'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $374(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg11'] = __r0, '', __r4;
        return;
    }
    function $15(__$ctx) {
        if ($$elem === 'core') {
    ...
    function $18(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $374(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg2'] = __r0, '', __r4;
        return;
    }
    function $23(__$ctx) {
        ...
        if (!!(__$ctx.ctx.mods || {}).theme === false) {
            {
                ...
                __r0.mods = __$ctx._.extend(__$ctx.ctx.mods || {}, { theme: 'pseudo' });
                $25(__$ctx);
                __r0.mods = __r1;
                '';
            }
    ...
    function $32(__$ctx) {
        if (!(__$ctx['__$anflg8'] !== true) === false) {
            if (!!$$elem === false) {
                var _$28mods = __$ctx.ctx.mods || {};
                _$28mods.theme = _$28mods.theme || 'normal';
                {
                    '';
    ...
    function $43(__$ctx) {
        var __r0, __r4, __r1, __r2, __r3;
        var _$1wctx = __$ctx.ctx, _$1welemMods = $$elemMods || {};
        if (__$ctx.isFirst()) {
            _$1welemMods.first = 'yes';
        } else {
            undefined;
        }
        var _$1wlink = {
                block: 'link',
                mods: {
                    disabled: _$1welemMods.disabled,
                    counter: $$mods.counter
                },
                mix: [{
                        block: $$block,
                        elem: _$1wctx.elem,
                        elemMods: _$1welemMods,
                        js: _$1wctx.js
                    }].concat(_$1wctx.mix),
                js: _$1wctx['link-js'] || Boolean(__$ctx._js),
                url: _$1wctx.url || '#'
            };
        [
            'content',
            ...
            if (_$1wctx[p]) {
                _$1wlink[p] = _$1wctx[p];
            } else {
                undefined;
            }
        });
        return '', __r0 = __$ctx['__$anflg6'], __$ctx['__$anflg6'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = _$1wlink, __r2 = $$mode, $$mode = '', __r3 = $374(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg6'] = __r0, '', __r4;
        return;
    }
    function $46(__$ctx) {
        if (!(__$ctx['__$anflg5'] !== true) === false) {
            if (!!$$elem === false) {
                ...
                return '', __r0 = __$ctx['__$anflg5'], __$ctx['__$anflg5'] = true, __r3 = ('', __r1 = __$ctx._js, __$ctx._js = __$ctx.ctx.js, __r2 = $40(__$ctx), __$ctx._js = __r1, '', __r2), __$ctx['__$anflg5'] = __r0, '', __r3;
                return;
            } else {
                return $381(__$ctx);
            }
    ...
    function $66(__$ctx) {
        ...
        var _$12ctx = __$ctx.ctx, _$12dtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $345(__$ctx), $$mode = __r0, '', __r1), _$12xUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $329(__$ctx), $$mode = __r2, '', __r3), _$12buf = [
                _$12dtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $73(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $374(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $105(__$ctx) {
        ...
        if (__t === 'button') {
            ...
            if (!($$mods && $$mods.control === 'menu') === false) {
                if (!!$$elem === false) {
                    var _$23ctx = __$ctx.ctx, _$23proxyMods = __$ctx.extend({}, _$23ctx.mods);
                    delete _$23proxyMods.control;
                    return {
                        block: 'tabs-menu',
                        js: true,
                        mix: [{
    ...
    function $124(__$ctx) {
        if (!(__$ctx['__$anflg1'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$xc = ('', __r0 = __$ctx['__$anflg1'], __$ctx['__$anflg1'] = true, __r1 = $124(__$ctx), __$ctx['__$anflg1'] = __r0, '', __r1);
                _$xc += [
    ...
    function $138(__$ctx) {
        if (!(__$ctx['__$anflg10'] !== true) === false) {
            if (!__$ctx.ctx.url === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$2bctx = __$ctx.ctx, _$2bp = ('', __r0 = __$ctx['__$anflg10'], __$ctx['__$anflg10'] = true, __r1 = $138(__$ctx), __$ctx['__$anflg10'] = __r0, '', __r1), _$2ba = { href: _$2bctx.url };
                    _$2bctx.target && (_$2ba.target = _$2bctx.target);
                    $$mods.disabled && (_$2ba['aria-disabled'] = true);
                    return __$ctx._.extend(_$2bp, _$2ba);
                    return;
                } else {
                    return $147(__$ctx);
                }
    ...
    function $151(__$ctx) {
        var __r0, __r1;
        var _$2actx = __$ctx.ctx, _$2ap = ('', __r0 = __$ctx['__$anflg9'], __$ctx['__$anflg9'] = true, __r1 = $138(__$ctx), __$ctx['__$anflg9'] = __r0, '', __r1), _$2aa = { type: _$2actx.type || 'button' }, _$2aprops = [
                'name',
                'value'
            ], _$2ai;
        while (_$2ai = _$2aprops.shift()) {
            _$2actx[_$2ai] && (_$2aa[_$2ai] = _$2actx[_$2ai]);
        }
        $$mods.disabled && (_$2aa.disabled = 'disabled');
        return __$ctx._.extend(_$2ap, _$2aa);
        return;
    }
    function $156(__$ctx) {
        if (!true === false) {
            if (!!$$elem === false) {
                var _$29ctx = __$ctx.ctx, _$29a = { role: 'button' };
                _$29ctx.tabindex && (_$29a.tabindex = _$29ctx.tabindex);
                return _$29a;
                return;
            } else {
                return $198(__$ctx);
    ...
    function $164(__$ctx) {
        if (!(__$ctx['__$anflg7'] !== true) === false) {
            if (!($$mods && $$mods.disabled === 'yes') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$20attrs = ('', __r0 = __$ctx['__$anflg7'], __$ctx['__$anflg7'] = true, __r1 = $164(__$ctx), __$ctx['__$anflg7'] = __r0, '', __r1) || {};
    ...
    function $287(__$ctx) {
        ...
        var _$1kmix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $284(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1kjsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $353(__$ctx), $$mode = __r3, '', __r4);
    ...
    function $290(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1gmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $284(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1gmix.push({
                    block: 'i-ua',
    ...
    function $353(__$ctx) {
        ...
        for (_$te in _$t_this) {
            if (_$t_this.hasOwnProperty(_$te) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$te, __r3 = $359(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $376(__$ctx) {
        ...
        while (_$fe = _$fes.shift()) {
            _$fps[_$fe] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$fe, __r3 = $76(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$fps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $367(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $401(__$ctx) {
        ...
        if (_$4tag) {
            ...
            _$4buf.push('<', _$4tag);
            var _$4isBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $303(__$ctx), $$mode = __r6, '', __r7);
            typeof _$4isBEM != 'undefined' || (_$4isBEM = typeof _$4v.bem != 'undefined' ? _$4v.bem : _$4v.block || _$4v.elem);
            var _$4cls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $334(__$ctx), $$mode = __r8, '', __r9);
            ...
            if (_$4isBEM || _$4cls) {
                ...
                if (_$4isBEM) {
                    ...
                    var _$4mix = ('', __r10 = $$mode, $$mode = 'mix', __r11 = $275(__$ctx), $$mode = __r10, '', __r11);
                    ...
                    if (_$4mix) {
                        ...
                        for (var _$4i = 0; _$4i < _$4mix.length; _$4i++) {
                            ...
                            if (_$4hasItem && !_$4visited[_$4visitedKey(_$4block, _$4elem)]) {
                                ...
                                var _$4nestedMix = ('', __r12 = $$block, $$block = _$4block, __r13 = $$elem, $$elem = _$4elem, __r14 = $$mods, $$mods = _$4mods, __r15 = $$elemMods, $$elemMods = _$4elemMods, __r16 = $$mode, $$mode = 'mix', __r17 = $275(__$ctx), $$block = __r12, $$elem = __r13, $$mods = __r14, $$elemMods = __r15, $$mode = __r16, '', __r17);
                                if (_$4nestedMix) {
            ...
            if (_$4jsParams) {
                var _$4jsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $380(__$ctx), $$mode = __r20, '', __r21);
        ...
        if (__$ctx._.isShortTag(_$4tag)) {
            ...
            _$4tag && _$4buf.push('>');
            var _$4content = ('', __r24 = $$mode, $$mode = 'content', __r25 = $105(__$ctx), $$mode = __r24, '', __r25);
