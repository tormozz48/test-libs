...
;
/* ../../../../common.blocks/tumbler/tumbler.examples/30-events.blocks/example/example.js begin */
BEM.DOM.decl('example', {
    ...
    onSetMod: {
        ...
        js: function() {
            ...
            var tumbler = this.findBlockInside('tumbler');

            BEM.blocks.button.on(
                this.domElem, 'click', function() {
                    var val = this.params.val;
                    val && tumbler.val(val);

                    var action = this.params.action;
                    action && tumbler[action]();
                }
            );
...
/* ../../../../common.blocks/tumbler/tumbler.examples/30-events.blocks/example/example.js end */
;
