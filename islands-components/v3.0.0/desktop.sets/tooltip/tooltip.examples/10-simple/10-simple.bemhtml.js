var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $388(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg14'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg13'], __$ctx['__$anflg13'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $388(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg13'] = __r0, '', __r4;
        return;
    }
    function $17(__$ctx) {
    ...
    function $28(__$ctx) {
        if (!(__$ctx['__$anflg12'] !== true) === false) {
            if (!($$mods && $$mods.size === 'l') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    return __$ctx.extend(('', __r0 = __$ctx['__$anflg12'], __$ctx['__$anflg12'] = true, __r1 = $28(__$ctx), __$ctx['__$anflg12'] = __r0, '', __r1), {
                        tailWidth: 24,
                        tailHeight: 12
                    });
                    return;
    ...
    function $37(__$ctx) {
        if (!(__$ctx['__$anflg11'] !== true) === false) {
            if (!($$mods && $$mods.size === 'm') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    return __$ctx.extend(('', __r0 = __$ctx['__$anflg11'], __$ctx['__$anflg11'] = true, __r1 = $28(__$ctx), __$ctx['__$anflg11'] = __r0, '', __r1), {
                        tailWidth: 14,
                        tailHeight: 7
                    });
                    return;
    ...
    function $46(__$ctx) {
        if (!(__$ctx['__$anflg10'] !== true) === false) {
            if (!($$mods && $$mods.size === 's') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    return __$ctx.extend(('', __r0 = __$ctx['__$anflg10'], __$ctx['__$anflg10'] = true, __r1 = $28(__$ctx), __$ctx['__$anflg10'] = __r0, '', __r1), {
                        tailWidth: 14,
                        tailHeight: 7
                    });
                    return;
    ...
    function $55(__$ctx) {
        if (!(__$ctx['__$anflg9'] !== true) === false) {
            if (!($$mods && $$mods.size === 'xs') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    return __$ctx.extend(('', __r0 = __$ctx['__$anflg9'], __$ctx['__$anflg9'] = true, __r1 = $28(__$ctx), __$ctx['__$anflg9'] = __r0, '', __r1), {
                        tailWidth: 14,
                        tailHeight: 7
                    });
                    return;
        ...
        if (__t === 'default') {
            ...
            if (__t === 'popup') {
                if (!(__$ctx['__$anflg8'] !== true) === false) {
                    if (!__$ctx._isInTooltip === false) {
                        if (!!$$elem === false) {
                            delete __$ctx._isInTooltip;
                            {
                                '';
    ...
    function $98(__$ctx) {
        var __r0, __r1;
        var _$23ctx = __$ctx.ctx, _$23mods = $$mods, _$23theme = _$23mods.theme, _$23popupMods = {
                adaptive: 'yes',
                autoclosable: _$23mods.autoclosable || 'no',
                theme: _$23theme
            }, _$23tooltipJs = ('', __r0 = $$mode, $$mode = 'js', __r1 = $28(__$ctx), $$mode = __r0, '', __r1);
        _$23tooltipJs = (_$23tooltipJs ? __$ctx.extend(_$23tooltipJs, _$23ctx.js === 'true' ? {} : _$23ctx.js) : _$23ctx.js) || {};
        var _$23offset = (_$23tooltipJs.offset ? -_$23tooltipJs.offset : 0) - (_$23tooltipJs.tailHeight ? _$23tooltipJs.tailHeight : 0), _$23popupJs = {
                directions: [
                    'right',
                    'bottom',
                    'top',
            ...
            };
        {
            ...
            var __r2 = $$mode;
            $$mode = '';
            var __r3 = __$ctx._isInTooltip;
            __$ctx._isInTooltip = true;
            var __r4 = __$ctx.ctx;
            __$ctx.ctx = {
                block: 'popup',
                mods: _$23popupMods,
    ...
    function $103(__$ctx) {
        if (!(__$ctx['__$anflg5'] !== true) === false) {
            if (!!$$elem === false) {
                var _$1ymods = __$ctx.ctx.mods || {};
                _$1ymods.theme = _$1ymods.theme || 'normal';
                {
                    '';
    ...
    function $123(__$ctx) {
        ...
        var _$12ctx = __$ctx.ctx, _$12dtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $359(__$ctx), $$mode = __r0, '', __r1), _$12xUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $323(__$ctx), $$mode = __r2, '', __r3), _$12buf = [
                _$12dtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $130(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $388(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $136(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $388(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg2'] = __r0, '', __r4;
        return;
    }
    function $141(__$ctx) {
        var __t = $$elem;
    ...
    function $181(__$ctx) {
        if (!(__$ctx['__$anflg1'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$xc = ('', __r0 = __$ctx['__$anflg1'], __$ctx['__$anflg1'] = true, __r1 = $181(__$ctx), __$ctx['__$anflg1'] = __r0, '', __r1);
                _$xc += [
    ...
    function $195(__$ctx) {
        if (!(__$ctx['__$anflg7'] !== true) === false) {
            if (!__$ctx.ctx.url === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$21ctx = __$ctx.ctx, _$21p = ('', __r0 = __$ctx['__$anflg7'], __$ctx['__$anflg7'] = true, __r1 = $195(__$ctx), __$ctx['__$anflg7'] = __r0, '', __r1), _$21a = { href: _$21ctx.url };
                    _$21ctx.target && (_$21a.target = _$21ctx.target);
                    $$mods.disabled && (_$21a['aria-disabled'] = true);
    ...
    function $208(__$ctx) {
        var __r0, __r1;
        var _$20ctx = __$ctx.ctx, _$20p = ('', __r0 = __$ctx['__$anflg6'], __$ctx['__$anflg6'] = true, __r1 = $195(__$ctx), __$ctx['__$anflg6'] = __r0, '', __r1), _$20a = { type: _$20ctx.type || 'button' }, _$20props = [
                'name',
                'value'
            ], _$20i;
    ...
    function $213(__$ctx) {
        if (!true === false) {
            if (!!$$elem === false) {
                var _$1zctx = __$ctx.ctx, _$1za = { role: 'button' };
    ...
    function $332(__$ctx) {
        ...
        var _$1kmix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $329(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1kjsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $367(__$ctx), $$mode = __r3, '', __r4);
    ...
    function $335(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1gmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $329(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1gmix.push({
                    block: 'i-ua',
    ...
    function $367(__$ctx) {
        ...
        for (_$te in _$t_this) {
            if (_$t_this.hasOwnProperty(_$te) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$te, __r3 = $373(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $390(__$ctx) {
        ...
        while (_$fe = _$fes.shift()) {
            _$fps[_$fe] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$fe, __r3 = $141(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$fps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $381(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $415(__$ctx) {
        ...
        if (_$4tag) {
            ...
            _$4buf.push('<', _$4tag);
            var _$4isBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $76(__$ctx), $$mode = __r6, '', __r7);
            typeof _$4isBEM != 'undefined' || (_$4isBEM = typeof _$4v.bem != 'undefined' ? _$4v.bem : _$4v.block || _$4v.elem);
            var _$4cls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $76(__$ctx), $$mode = __r8, '', __r9);
            ...
            if (_$4jsParams) {
                var _$4jsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $76(__$ctx), $$mode = __r20, '', __r21);
                _$4buf.push(' ', _$4jsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$4jsParams)), '"');
            } else {
                undefined;
            }
            var _$4attrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $76(__$ctx), $$mode = __r22, '', __r23);
        ...
        if (__$ctx._.isShortTag(_$4tag)) {
            ...
            _$4tag && _$4buf.push('>');
            var _$4content = ('', __r24 = $$mode, $$mode = 'content', __r25 = $68(__$ctx), $$mode = __r24, '', __r25);
