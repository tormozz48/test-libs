  ...
  var cache,
    ...
    function $16(__$ctx) {
        if (!(__$ctx['__$anflg28'] !== true) === false) {
            var __r0, __r1;
            return __$ctx.extend(('', __r0 = __$ctx['__$anflg28'], __$ctx['__$anflg28'] = true, __r1 = $16(__$ctx), __$ctx['__$anflg28'] = __r0, '', __r1) || {}, { autocomplete: 'off' });
            return;
        } else {
            var _$cwa = __$ctx._.extend({
                    id: __$ctx._inputId,
                    name: __$ctx._name
                }, __$ctx.ctx.controlAttrs);
            (__$ctx._value || __$ctx._value === 0) && (_$cwa.value = __$ctx._value);
            $$mods.disabled && (_$cwa.disabled = 'disabled');
            _$cwa['aria-labelledby'] = __$ctx._labelId + ' ' + __$ctx._hintId;
            return _$cwa;
            return;
        }
    }
    ...
    function $49(__$ctx) {
        var __r0, __r1, __r2;
        var _$ckvalue = ('', __r0 = $$mode, $$mode = 'value', __r1 = __$ctx.ctx, __$ctx.ctx = __$ctx.ctx.value, __r2 = $82(__$ctx), $$mode = __r0, __$ctx.ctx = __r1, '', __r2), _$ckid = __$ctx.ctx.id || __$ctx.generateId(), _$ckmods = __$ctx.ctx.mods || {};
        _$ckmods.theme = _$ckmods.theme || 'normal';
        {
            '';
            var __r3 = __$ctx['__$anflg26'];
            __$ctx['__$anflg26'] = true;
            {
                '';
                var __r4 = __$ctx._inputId;
                __$ctx._inputId = _$ckid;
                var __r5 = __$ctx._labelId;
                __$ctx._labelId = 'label' + _$ckid;
                var __r6 = __$ctx._hintId;
                __$ctx._hintId = 'hint' + _$ckid;
                var __r7 = __$ctx._name;
                __$ctx._name = __$ctx.ctx.name || '';
                var __r8 = __$ctx._value;
                __$ctx._value = _$ckvalue;
    ...
    function $105(__$ctx) {
        if (!(__$ctx['__$anflg25'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$chc = ('', __r0 = __$ctx['__$anflg25'], __$ctx['__$anflg25'] = true, __r1 = $105(__$ctx), __$ctx['__$anflg25'] = __r0, '', __r1);
                _$chc += [
    ...
    function $131(__$ctx) {
        ...
        var _$cd_this = __$ctx['i-global'], _$cdjs = {}, _$cdblock = {
                block: 'i-global',
                js: _$cdjs
            }, _$cde;
        for (_$cde in _$cd_this) {
            if (_$cd_this.hasOwnProperty(_$cde) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$cde, __r3 = $137(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
                _$cdjs[_$cde] = _$cd_this[_$cde];
            } else {
                undefined;
            }
        }
    ...
    function $166(__$ctx) {
        var _$c1params = __$ctx.ctx.params || {}, _$c1iGlobal = __$ctx['i-global'], _$c1isTldChanged = _$c1params.tld && _$c1params.tld !== _$c1iGlobal.tld, _$c1tld, _$c1xYaDomain, _$c1yaDomain;
        if (_$c1isTldChanged) {
            _$c1tld = _$c1params.tld;
            _$c1xYaDomain = _$c1tld === 'tr' ? 'yandex.com.tr' : 'yandex.' + _$c1tld;
            _$c1yaDomain = [
                'ua',
                'by',
                'kz'
            ].indexOf(_$c1tld) != -1 ? 'yandex.ru' : _$c1xYaDomain;
            _$c1iGlobal['content-region'] = _$c1tld;
            _$c1iGlobal['click-host'] = '//clck.' + _$c1yaDomain;
            _$c1iGlobal['passport-host'] = 'https://passport.' + _$c1yaDomain;
            _$c1iGlobal['pass-host'] = '//pass.' + _$c1xYaDomain;
            _$c1iGlobal['social-host'] = '//social.' + _$c1xYaDomain;
            _$c1iGlobal['export-host'] = '//export.' + _$c1xYaDomain;
        } else {
            undefined;
        }
        for (var _$c1p in _$c1params) {
            _$c1iGlobal[_$c1p] = _$c1params[_$c1p];
        }
        return;
    }
    function $169(__$ctx) {
    ...
    function $179(__$ctx) {
        ...
        while (_$bze = _$bzes.shift()) {
            _$bzps[_$bze] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$bze, __r3 = $142(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$bzps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $169(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $202(__$ctx) {
        ...
        if (!cache || !__$ctx._cacheLog) {
            return _$bqfollow.call(__$ctx);
        } else {
            undefined;
        }
        var _$bqcontents = __$ctx._buf.slice(__$ctx._cachePos).join('');
        __$ctx._cachePos = __$ctx._buf.length;
        __$ctx._cacheLog.push(_$bqcontents, {
            log: __$ctx._localLog.slice(),
            link: __$ctx.ctx.link
        });
        var _$bqres = _$bqfollow.call(__$ctx);
        __$ctx._cachePos = __$ctx._buf.length;
        return _$bqres;
        return;
    }
    ...
    function $211(__$ctx) {
        var _$bpcached;
        function _$bpsetProperty(obj, key, value) {
            if (key.length === 0) {
                return undefined;
            } else {
                undefined;
        ...
        if (_$bpcached = cache.get(__$ctx.ctx.cache)) {
            var _$bpoldLinks = __$ctx._links;
            if (__$ctx.ctx.links) {
                __$ctx._links = __$ctx.ctx.links;
            } else {
                undefined;
            }
            for (var _$bpi = 0; _$bpi < _$bpcached.log.length; _$bpi++) {
                if (typeof _$bpcached.log[_$bpi] === 'string') {
                    __$ctx._buf.push(_$bpcached.log[_$bpi]);
                    continue;
                } else {
                    undefined;
                }
                var _$bplog = _$bpcached.log[_$bpi], _$bpreverseLog;
                _$bpreverseLog = _$bplog.log.map(function (entry) {
                    return {
                        key: entry[0],
                        value: _$bpsetProperty(this, entry[0], entry[1])
                    };
                }, __$ctx).reverse();
                {
                    '';
                ...
                undefined;
                _$bpreverseLog.forEach(function (entry) {
                    _$bpsetProperty(this, entry.key, entry.value);
                }, __$ctx);
            }
            __$ctx._links = _$bpoldLinks;
            return _$bpcached.res;
        } else {
            undefined;
        }
        var _$bpcacheLog = [], _$bpres;
        {
            '';
            ...
            __$ctx._cacheLog = _$bpcacheLog;
            var __r9 = __$ctx._localLog;
            __$ctx._localLog = [];
            {
                _$bpres = $1(__$ctx);
                var _$bptail = __$ctx._buf.slice(__$ctx._cachePos).join('');
                if (_$bptail) {
                    _$bpcacheLog.push(_$bptail);
                } else {
                    undefined;
                }
            }
    ...
    function $216(__$ctx) {
        ...
        if (__t === 'default') {
            ...
            if (!__$ctx._.isSimple(__$ctx.ctx) === false) {
                __$ctx._listLength--;
                var _$bnctx = __$ctx.ctx;
                (_$bnctx && _$bnctx !== true || _$bnctx === 0) && __$ctx._buf.push(_$bnctx);
                return;
            } else {
                if (!!__$ctx.ctx === false) {
                    __$ctx._listLength--;
    ...
    function $218(__$ctx) {
        ...
        var _$boBEM_ = __$ctx.BEM, _$bov = __$ctx.ctx, _$bobuf = __$ctx._buf, _$botag;
        _$botag = ('', __r0 = $$mode, $$mode = 'tag', __r1 = $1(__$ctx), $$mode = __r0, '', __r1);
        typeof _$botag != 'undefined' || (_$botag = _$bov.tag);
        typeof _$botag != 'undefined' || (_$botag = 'div');
        if (_$botag) {
            var _$bojsParams, _$bojs;
            if ($$block && _$bov.js !== false) {
                _$bojs = ('', __r4 = $$mode, $$mode = 'js', __r5 = $1(__$ctx), $$mode = __r4, '', __r5);
                _$bojs = _$bojs ? __$ctx._.extend(_$bov.js, _$bojs === true ? {} : _$bojs) : _$bov.js === true ? {} : _$bov.js;
                _$bojs && ((_$bojsParams = {})[_$boBEM_.INTERNAL.buildClass($$block, _$bov.elem)] = _$bojs);
            } else {
                undefined;
            }
            _$bobuf.push('<', _$botag);
            var _$boisBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $1(__$ctx), $$mode = __r6, '', __r7);
            typeof _$boisBEM != 'undefined' || (_$boisBEM = typeof _$bov.bem != 'undefined' ? _$bov.bem : _$bov.block || _$bov.elem);
            var _$bocls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $1(__$ctx), $$mode = __r8, '', __r9);
            _$bocls || (_$bocls = _$bov.cls);
            var _$boaddJSInitClass = _$bov.block && _$bojsParams;
            if (_$boisBEM || _$bocls) {
                _$bobuf.push(' class="');
                if (_$boisBEM) {
                    _$boBEM_.INTERNAL.buildClasses($$block, _$bov.elem, _$bov.elemMods || _$bov.mods, _$bobuf);
                    var _$bomix = ('', __r10 = $$mode, $$mode = 'mix', __r11 = $1(__$ctx), $$mode = __r10, '', __r11);
                    _$bov.mix && (_$bomix = _$bomix ? _$bomix.concat(_$bov.mix) : _$bov.mix);
                    if (_$bomix) {
                        var _$bovisited = {};
                        function _$bovisitedKey(block, elem) {
                            return (block || '') + '__' + (elem || '');
                        }
                        _$bovisited[_$bovisitedKey($$block, $$elem)] = true;
                        if (!__$ctx._.isArray(_$bomix)) {
                            _$bomix = [_$bomix];
                        } else {
                            undefined;
                        }
                        for (var _$boi = 0; _$boi < _$bomix.length; _$boi++) {
                            var _$bomixItem = _$bomix[_$boi];
                            if (!_$bomixItem) {
                                continue;
                            } else {
                                undefined;
                            }
                            var _$bohasItem = _$bomixItem.block || _$bomixItem.elem, _$boblock = _$bomixItem.block || _$bomixItem._block || $$block, _$boelem = _$bomixItem.elem || _$bomixItem._elem || $$elem, _$bomods = _$bomixItem.mods || $$mods, _$boelemMods = _$bomixItem.elemMods || {};
                            _$bohasItem && _$bobuf.push(' ');
                            _$boBEM_.INTERNAL[_$bohasItem ? 'buildClasses' : 'buildModsClasses'](_$boblock, _$bomixItem.elem || _$bomixItem._elem || (_$bomixItem.block ? undefined : $$elem), _$bomixItem.elemMods || _$bomixItem.mods, _$bobuf);
                            if (_$bomixItem.js) {
                                (_$bojsParams || (_$bojsParams = {}))[_$boBEM_.INTERNAL.buildClass(_$boblock, _$bomixItem.elem)] = _$bomixItem.js === true ? {} : _$bomixItem.js;
                                _$boaddJSInitClass || (_$boaddJSInitClass = _$boblock && !_$bomixItem.elem);
                            } else {
                                undefined;
                            }
                            if (_$bohasItem && !_$bovisited[_$bovisitedKey(_$boblock, _$boelem)]) {
                                _$bovisited[_$bovisitedKey(_$boblock, _$boelem)] = true;
                                var _$bonestedMix = ('', __r12 = $$block, $$block = _$boblock, __r13 = $$elem, $$elem = _$boelem, __r14 = $$mods, $$mods = _$bomods, __r15 = $$elemMods, $$elemMods = _$boelemMods, __r16 = $$mode, $$mode = 'mix', __r17 = $1(__$ctx), $$block = __r12, $$elem = __r13, $$mods = __r14, $$elemMods = __r15, $$mode = __r16, '', __r17);
                                if (_$bonestedMix) {
                                    for (var _$boj = 0; _$boj < _$bonestedMix.length; _$boj++) {
                                        var _$bonestedItem = _$bonestedMix[_$boj];
                                        if (!_$bonestedItem.block && !_$bonestedItem.elem || !_$bovisited[_$bovisitedKey(_$bonestedItem.block, _$bonestedItem.elem)]) {
                                            _$bonestedItem._block = _$boblock;
                                            _$bonestedItem._elem = _$boelem;
                                            _$bomix.splice(_$boi + 1, 0, _$bonestedItem);
                                        } else {
                                            undefined;
                                        }
                                    }
                ...
                _$bocls && _$bobuf.push(_$boisBEM ? ' ' : '', _$bocls);
                _$boaddJSInitClass && _$bobuf.push(' i-bem');
                _$bobuf.push('"');
            } else {
                undefined;
            }
            if (_$bojsParams) {
                var _$bojsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $1(__$ctx), $$mode = __r20, '', __r21);
                _$bobuf.push(' ', _$bojsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$bojsParams)), '"');
            } else {
                undefined;
            }
            var _$boattrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $1(__$ctx), $$mode = __r22, '', __r23);
            _$boattrs = __$ctx._.extend(_$boattrs, _$bov.attrs);
            if (_$boattrs) {
                var _$boname;
                for (_$boname in _$boattrs) {
                    if (_$boattrs[_$boname] === undefined) {
                        continue;
                    } else {
                        undefined;
                    }
                    _$bobuf.push(' ', _$boname, '="', __$ctx._.attrEscape(_$boattrs[_$boname]), '"');
                }
            } else {
                undefined;
            }
        ...
        if (__$ctx._.isShortTag(_$botag)) {
            _$bobuf.push('/>');
        } else {
            _$botag && _$bobuf.push('>');
            var _$bocontent = ('', __r24 = $$mode, $$mode = 'content', __r25 = $1(__$ctx), $$mode = __r24, '', __r25);
            if (_$bocontent || _$bocontent === 0) {
                var _$boisBEM = $$block || $$elem;
                {
                    '';
                    var __r26 = __$ctx._notNewList;
                    __$ctx._notNewList = false;
                    var __r27 = __$ctx.position;
                    __$ctx.position = _$boisBEM ? 1 : __$ctx.position;
                    var __r28 = __$ctx._listLength;
                    __$ctx._listLength = _$boisBEM ? 1 : __$ctx._listLength;
                    var __r29 = __$ctx.ctx;
                    __$ctx.ctx = _$bocontent;
                    var __r30 = $$mode;
                    $$mode = '';
                    $1(__$ctx);
            ...
            _$botag && _$bobuf.push('</', _$botag, '>');
        }
        return;
    }
    function $227(__$ctx) {
        var _$blv = __$ctx.ctx, _$bll = _$blv.length, _$bli = 0, _$blprevPos = __$ctx.position, _$blprevNotNewList = __$ctx._notNewList;
        if (_$blprevNotNewList) {
            __$ctx._listLength += _$bll - 1;
        } else {
            __$ctx.position = 0;
            __$ctx._listLength = _$bll;
        }
        __$ctx._notNewList = true;
        while (_$bli < _$bll) {
            var _$blnewCtx = _$blv[_$bli++];
            {
                '';
                var __r0 = __$ctx.ctx;
                __$ctx.ctx = _$blnewCtx == null ? '' : _$blnewCtx;
                $1(__$ctx);
                __$ctx.ctx = __r0;
                '';
            }
        ...
        _$blprevNotNewList || (__$ctx.position = _$blprevPos);
        return;
    }
    function $230(__$ctx) {
        var _$bkvBlock = __$ctx.ctx.block, _$bkvElem = __$ctx.ctx.elem, _$bkblock = __$ctx._currBlock || $$block;
        __$ctx.ctx || (__$ctx.ctx = {});
        {
            ...
            var __r2 = $$block;
            $$block = _$bkvBlock || (_$bkvElem ? _$bkblock : undefined);
            var __r3 = __$ctx._currBlock;
            __$ctx._currBlock = _$bkvBlock || _$bkvElem ? undefined : _$bkblock;
            var __r4 = $$elem;
            $$elem = __$ctx.ctx.elem;
            var __r5 = $$mods;
            $$mods = (_$bkvBlock ? __$ctx.ctx.mods : $$mods) || {};
            var __r6 = $$elemMods;
