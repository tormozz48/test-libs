var BEMHTML = function() {
  ...
  var cache,
        ...
        if (__t === 'input') {
            ...
            if (__t === 'content') {
                ...
                if (__t === 'clear') {
                    ...
                    var _$bfa = __$ctx._.extend({
                            id: __$ctx._inputId,
                            name: __$ctx._name
                        }, __$ctx.ctx.controlAttrs);
                    (__$ctx._value || __$ctx._value === 0) && (_$bfa.value = __$ctx._value);
                    $$mods.disabled && (_$bfa.disabled = 'disabled');
                    _$bfa['aria-labelledby'] = __$ctx._labelId + ' ' + __$ctx._hintId;
                    return _$bfa;
                    return;
                } else {
                    return $155(__$ctx);
    ...
    function $46(__$ctx) {
        var __r0, __r1, __r2;
        var _$b6value = ('', __r0 = $$mode, $$mode = 'value', __r1 = __$ctx.ctx, __$ctx.ctx = __$ctx.ctx.value, __r2 = $56(__$ctx), $$mode = __r0, __$ctx.ctx = __r1, '', __r2), _$b6id = __$ctx.ctx.id || __$ctx.generateId(), _$b6mods = __$ctx.ctx.mods || {};
        _$b6mods.theme = _$b6mods.theme || 'normal';
        {
            '';
            var __r3 = __$ctx['__$anflg23'];
            __$ctx['__$anflg23'] = true;
            {
                '';
                var __r4 = __$ctx._inputId;
                __$ctx._inputId = _$b6id;
                var __r5 = __$ctx._labelId;
                __$ctx._labelId = 'label' + _$b6id;
                var __r6 = __$ctx._hintId;
                __$ctx._hintId = 'hint' + _$b6id;
                var __r7 = __$ctx._name;
                __$ctx._name = __$ctx.ctx.name || '';
                var __r8 = __$ctx._value;
                __$ctx._value = _$b6value;
    ...
    function $84(__$ctx) {
        if (!(__$ctx['__$anflg22'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$b3c = ('', __r0 = __$ctx['__$anflg22'], __$ctx['__$anflg22'] = true, __r1 = $84(__$ctx), __$ctx['__$anflg22'] = __r0, '', __r1);
                _$b3c += [
    ...
    function $110(__$ctx) {
        ...
        var _$az_this = __$ctx['i-global'], _$azjs = {}, _$azblock = {
                block: 'i-global',
                js: _$azjs
            }, _$aze;
        for (_$aze in _$az_this) {
            if (_$az_this.hasOwnProperty(_$aze) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$aze, __r3 = $116(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
                _$azjs[_$aze] = _$az_this[_$aze];
            } else {
                undefined;
            }
        }
    ...
    function $145(__$ctx) {
        var _$anparams = __$ctx.ctx.params || {}, _$aniGlobal = __$ctx['i-global'], _$anisTldChanged = _$anparams.tld && _$anparams.tld !== _$aniGlobal.tld, _$antld, _$anxYaDomain, _$anyaDomain;
        if (_$anisTldChanged) {
            _$antld = _$anparams.tld;
            _$anxYaDomain = _$antld === 'tr' ? 'yandex.com.tr' : 'yandex.' + _$antld;
            _$anyaDomain = [
                'ua',
                'by',
                'kz'
            ].indexOf(_$antld) != -1 ? 'yandex.ru' : _$anxYaDomain;
            _$aniGlobal['content-region'] = _$antld;
            _$aniGlobal['click-host'] = '//clck.' + _$anyaDomain;
            _$aniGlobal['passport-host'] = 'https://passport.' + _$anyaDomain;
            _$aniGlobal['pass-host'] = '//pass.' + _$anxYaDomain;
            _$aniGlobal['social-host'] = '//social.' + _$anxYaDomain;
            _$aniGlobal['export-host'] = '//export.' + _$anxYaDomain;
        } else {
            undefined;
        }
        for (var _$anp in _$anparams) {
            _$aniGlobal[_$anp] = _$anparams[_$anp];
        }
        return;
    }
    function $148(__$ctx) {
    ...
    function $158(__$ctx) {
        ...
        while (_$ale = _$ales.shift()) {
            _$alps[_$ale] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ale, __r3 = $121(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$alps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $148(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $181(__$ctx) {
        ...
        if (!cache || !__$ctx._cacheLog) {
            return _$acfollow.call(__$ctx);
        } else {
            undefined;
        }
        var _$accontents = __$ctx._buf.slice(__$ctx._cachePos).join('');
        __$ctx._cachePos = __$ctx._buf.length;
        __$ctx._cacheLog.push(_$accontents, {
            log: __$ctx._localLog.slice(),
            link: __$ctx.ctx.link
        });
        var _$acres = _$acfollow.call(__$ctx);
        __$ctx._cachePos = __$ctx._buf.length;
        return _$acres;
        return;
    }
    ...
    function $190(__$ctx) {
        var _$abcached;
        function _$absetProperty(obj, key, value) {
            if (key.length === 0) {
                return undefined;
            } else {
                undefined;
        ...
        if (_$abcached = cache.get(__$ctx.ctx.cache)) {
            var _$aboldLinks = __$ctx._links;
            if (__$ctx.ctx.links) {
                __$ctx._links = __$ctx.ctx.links;
            } else {
                undefined;
            }
            for (var _$abi = 0; _$abi < _$abcached.log.length; _$abi++) {
                if (typeof _$abcached.log[_$abi] === 'string') {
                    __$ctx._buf.push(_$abcached.log[_$abi]);
                    continue;
                } else {
                    undefined;
                }
                var _$ablog = _$abcached.log[_$abi], _$abreverseLog;
                _$abreverseLog = _$ablog.log.map(function (entry) {
                    return {
                        key: entry[0],
                        value: _$absetProperty(this, entry[0], entry[1])
                    };
                }, __$ctx).reverse();
                {
                    '';
                ...
                undefined;
                _$abreverseLog.forEach(function (entry) {
                    _$absetProperty(this, entry.key, entry.value);
                }, __$ctx);
            }
            __$ctx._links = _$aboldLinks;
            return _$abcached.res;
        } else {
            undefined;
        }
        var _$abcacheLog = [], _$abres;
        {
            '';
            ...
            __$ctx._cacheLog = _$abcacheLog;
            var __r9 = __$ctx._localLog;
            __$ctx._localLog = [];
            {
                _$abres = $1(__$ctx);
                var _$abtail = __$ctx._buf.slice(__$ctx._cachePos).join('');
                if (_$abtail) {
                    _$abcacheLog.push(_$abtail);
                } else {
                    undefined;
                }
            }
    ...
    function $195(__$ctx) {
        ...
        if (__t === 'default') {
            ...
            if (!__$ctx._.isSimple(__$ctx.ctx) === false) {
                __$ctx._listLength--;
                var _$a9ctx = __$ctx.ctx;
                (_$a9ctx && _$a9ctx !== true || _$a9ctx === 0) && __$ctx._buf.push(_$a9ctx);
                return;
            } else {
                if (!!__$ctx.ctx === false) {
                    __$ctx._listLength--;
    ...
    function $197(__$ctx) {
        ...
        var _$aaBEM_ = __$ctx.BEM, _$aav = __$ctx.ctx, _$aabuf = __$ctx._buf, _$aatag;
        _$aatag = ('', __r0 = $$mode, $$mode = 'tag', __r1 = $1(__$ctx), $$mode = __r0, '', __r1);
        typeof _$aatag != 'undefined' || (_$aatag = _$aav.tag);
        typeof _$aatag != 'undefined' || (_$aatag = 'div');
        if (_$aatag) {
            var _$aajsParams, _$aajs;
            if ($$block && _$aav.js !== false) {
                _$aajs = ('', __r4 = $$mode, $$mode = 'js', __r5 = $1(__$ctx), $$mode = __r4, '', __r5);
                _$aajs = _$aajs ? __$ctx._.extend(_$aav.js, _$aajs === true ? {} : _$aajs) : _$aav.js === true ? {} : _$aav.js;
                _$aajs && ((_$aajsParams = {})[_$aaBEM_.INTERNAL.buildClass($$block, _$aav.elem)] = _$aajs);
            } else {
                undefined;
            }
            _$aabuf.push('<', _$aatag);
            var _$aaisBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $1(__$ctx), $$mode = __r6, '', __r7);
            typeof _$aaisBEM != 'undefined' || (_$aaisBEM = typeof _$aav.bem != 'undefined' ? _$aav.bem : _$aav.block || _$aav.elem);
            var _$aacls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $1(__$ctx), $$mode = __r8, '', __r9);
            _$aacls || (_$aacls = _$aav.cls);
            var _$aaaddJSInitClass = _$aav.block && _$aajsParams;
            if (_$aaisBEM || _$aacls) {
                _$aabuf.push(' class="');
                if (_$aaisBEM) {
                    _$aaBEM_.INTERNAL.buildClasses($$block, _$aav.elem, _$aav.elemMods || _$aav.mods, _$aabuf);
                    var _$aamix = ('', __r10 = $$mode, $$mode = 'mix', __r11 = $1(__$ctx), $$mode = __r10, '', __r11);
                    _$aav.mix && (_$aamix = _$aamix ? _$aamix.concat(_$aav.mix) : _$aav.mix);
                    if (_$aamix) {
                        var _$aavisited = {};
                        function _$aavisitedKey(block, elem) {
                            return (block || '') + '__' + (elem || '');
                        }
                        _$aavisited[_$aavisitedKey($$block, $$elem)] = true;
                        if (!__$ctx._.isArray(_$aamix)) {
                            _$aamix = [_$aamix];
                        } else {
                            undefined;
                        }
                        for (var _$aai = 0; _$aai < _$aamix.length; _$aai++) {
                            var _$aamixItem = _$aamix[_$aai];
                            if (!_$aamixItem) {
                                continue;
                            } else {
                                undefined;
                            }
                            var _$aahasItem = _$aamixItem.block || _$aamixItem.elem, _$aablock = _$aamixItem.block || _$aamixItem._block || $$block, _$aaelem = _$aamixItem.elem || _$aamixItem._elem || $$elem, _$aamods = _$aamixItem.mods || $$mods, _$aaelemMods = _$aamixItem.elemMods || {};
                            _$aahasItem && _$aabuf.push(' ');
                            _$aaBEM_.INTERNAL[_$aahasItem ? 'buildClasses' : 'buildModsClasses'](_$aablock, _$aamixItem.elem || _$aamixItem._elem || (_$aamixItem.block ? undefined : $$elem), _$aamixItem.elemMods || _$aamixItem.mods, _$aabuf);
                            if (_$aamixItem.js) {
                                (_$aajsParams || (_$aajsParams = {}))[_$aaBEM_.INTERNAL.buildClass(_$aablock, _$aamixItem.elem)] = _$aamixItem.js === true ? {} : _$aamixItem.js;
                                _$aaaddJSInitClass || (_$aaaddJSInitClass = _$aablock && !_$aamixItem.elem);
                            } else {
                                undefined;
                            }
                            if (_$aahasItem && !_$aavisited[_$aavisitedKey(_$aablock, _$aaelem)]) {
                                _$aavisited[_$aavisitedKey(_$aablock, _$aaelem)] = true;
                                var _$aanestedMix = ('', __r12 = $$block, $$block = _$aablock, __r13 = $$elem, $$elem = _$aaelem, __r14 = $$mods, $$mods = _$aamods, __r15 = $$elemMods, $$elemMods = _$aaelemMods, __r16 = $$mode, $$mode = 'mix', __r17 = $1(__$ctx), $$block = __r12, $$elem = __r13, $$mods = __r14, $$elemMods = __r15, $$mode = __r16, '', __r17);
                                if (_$aanestedMix) {
                                    for (var _$aaj = 0; _$aaj < _$aanestedMix.length; _$aaj++) {
                                        var _$aanestedItem = _$aanestedMix[_$aaj];
                                        if (!_$aanestedItem.block && !_$aanestedItem.elem || !_$aavisited[_$aavisitedKey(_$aanestedItem.block, _$aanestedItem.elem)]) {
                                            _$aanestedItem._block = _$aablock;
                                            _$aanestedItem._elem = _$aaelem;
                                            _$aamix.splice(_$aai + 1, 0, _$aanestedItem);
                                        } else {
                                            undefined;
                                        }
                                    }
                ...
                _$aacls && _$aabuf.push(_$aaisBEM ? ' ' : '', _$aacls);
                _$aaaddJSInitClass && _$aabuf.push(' i-bem');
                _$aabuf.push('"');
            } else {
                undefined;
            }
            if (_$aajsParams) {
                var _$aajsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $1(__$ctx), $$mode = __r20, '', __r21);
                _$aabuf.push(' ', _$aajsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$aajsParams)), '"');
            } else {
                undefined;
            }
            var _$aaattrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $1(__$ctx), $$mode = __r22, '', __r23);
            _$aaattrs = __$ctx._.extend(_$aaattrs, _$aav.attrs);
            if (_$aaattrs) {
                var _$aaname;
                for (_$aaname in _$aaattrs) {
                    if (_$aaattrs[_$aaname] === undefined) {
                        continue;
                    } else {
                        undefined;
                    }
                    _$aabuf.push(' ', _$aaname, '="', __$ctx._.attrEscape(_$aaattrs[_$aaname]), '"');
                }
            } else {
                undefined;
            }
        ...
        if (__$ctx._.isShortTag(_$aatag)) {
            _$aabuf.push('/>');
        } else {
            _$aatag && _$aabuf.push('>');
            var _$aacontent = ('', __r24 = $$mode, $$mode = 'content', __r25 = $1(__$ctx), $$mode = __r24, '', __r25);
            if (_$aacontent || _$aacontent === 0) {
                var _$aaisBEM = $$block || $$elem;
                {
                    '';
                    var __r26 = __$ctx._notNewList;
                    __$ctx._notNewList = false;
                    var __r27 = __$ctx.position;
                    __$ctx.position = _$aaisBEM ? 1 : __$ctx.position;
                    var __r28 = __$ctx._listLength;
                    __$ctx._listLength = _$aaisBEM ? 1 : __$ctx._listLength;
                    var __r29 = __$ctx.ctx;
                    __$ctx.ctx = _$aacontent;
                    var __r30 = $$mode;
                    $$mode = '';
                    $1(__$ctx);
            ...
            _$aatag && _$aabuf.push('</', _$aatag, '>');
        }
        return;
    }
    function $206(__$ctx) {
        var _$a7v = __$ctx.ctx, _$a7l = _$a7v.length, _$a7i = 0, _$a7prevPos = __$ctx.position, _$a7prevNotNewList = __$ctx._notNewList;
        if (_$a7prevNotNewList) {
            __$ctx._listLength += _$a7l - 1;
        } else {
            __$ctx.position = 0;
            __$ctx._listLength = _$a7l;
        }
        __$ctx._notNewList = true;
        while (_$a7i < _$a7l) {
            var _$a7newCtx = _$a7v[_$a7i++];
            {
                '';
                var __r0 = __$ctx.ctx;
                __$ctx.ctx = _$a7newCtx == null ? '' : _$a7newCtx;
                $1(__$ctx);
                __$ctx.ctx = __r0;
                '';
            }
        ...
        _$a7prevNotNewList || (__$ctx.position = _$a7prevPos);
        return;
    }
    function $209(__$ctx) {
        var _$a6vBlock = __$ctx.ctx.block, _$a6vElem = __$ctx.ctx.elem, _$a6block = __$ctx._currBlock || $$block;
        __$ctx.ctx || (__$ctx.ctx = {});
        {
            ...
            var __r2 = $$block;
            $$block = _$a6vBlock || (_$a6vElem ? _$a6block : undefined);
            var __r3 = __$ctx._currBlock;
            __$ctx._currBlock = _$a6vBlock || _$a6vElem ? undefined : _$a6block;
            var __r4 = $$elem;
            $$elem = __$ctx.ctx.elem;
            var __r5 = $$mods;
            $$mods = (_$a6vBlock ? __$ctx.ctx.mods : $$mods) || {};
            var __r6 = $$elemMods;
...
;
/* ../../../../common.blocks/input/_autofocus/input_autofocus_yes.js begin */
(function() {
...
var isTextKey = function(e) {
    ...
    var keyCode = e.charCode || e.keyCode || e.which || 0,
        isMetaKey = e.ctrlKey || e.altKey || e.metaKey,
        isDigit = keyCode >= 48 && keyCode <= 57,
        isNumpad = keyCode >= 96 && keyCode <= 105,
        isLetter = [
            keyCode >= 65 && keyCode <= 90,
            keyCode >= 1025 && keyCode <= 1071,
            keyCode === 0,
            keyCode === 231 // https://st.yandex-team.ru/ISLCOMPONENTS-222
        ].some(Boolean);
    return !isMetaKey && (isDigit || isNumpad || isLetter);
...
BEM.DOM.decl({name: 'input', modName: 'autofocus', modVal: 'yes'}, {
     ...
     *
     * @private
     * @param  {$.Event} e Объект DOM-события нажатия клавиши.
     */
...
/* ../../../../common.blocks/input/_autofocus/input_autofocus_yes.js end */
;
