var BEMHTML = function() {
  ...
  var cache,
        ...
        if (__t === 'input') {
            ...
            if (__t === 'content') {
                ...
                if (__t === 'clear') {
                    ...
                    var _$sha = __$ctx._.extend({
                            id: __$ctx._inputId,
                            name: __$ctx._name
                        }, __$ctx.ctx.controlAttrs);
                    (__$ctx._value || __$ctx._value === 0) && (_$sha.value = __$ctx._value);
                    $$mods.disabled && (_$sha.disabled = 'disabled');
                    _$sha['aria-labelledby'] = __$ctx._labelId + ' ' + __$ctx._hintId;
                    return _$sha;
                    return;
                } else {
                    return $155(__$ctx);
    ...
    function $34(__$ctx) {
        if ($$elem === 'control') {
            if (!(__$ctx['__$anflg62'] !== true) === false) {
                if (!!$$mods.clear === false) {
                    return $38(__$ctx);
                } else {
                    return $43(__$ctx);
    ...
    function $38(__$ctx) {
        {
            '';
            var __r0 = __$ctx['__$anflg62'];
            __$ctx['__$anflg62'] = true;
            {
                '';
                var __r1 = __$ctx.ctx;
                __$ctx.ctx = {
    ...
    function $43(__$ctx) {
        if (!(__$ctx['__$anflg61'] !== true) === false) {
            if (!!$$elem === false) {
                return $46(__$ctx);
            } else {
                return $155(__$ctx);
    ...
    function $46(__$ctx) {
        var __r0, __r1, __r2;
        var _$s8value = ('', __r0 = $$mode, $$mode = 'value', __r1 = __$ctx.ctx, __$ctx.ctx = __$ctx.ctx.value, __r2 = $56(__$ctx), $$mode = __r0, __$ctx.ctx = __r1, '', __r2), _$s8id = __$ctx.ctx.id || __$ctx.generateId(), _$s8mods = __$ctx.ctx.mods || {};
        _$s8mods.theme = _$s8mods.theme || 'normal';
        {
            '';
            var __r3 = __$ctx['__$anflg61'];
            __$ctx['__$anflg61'] = true;
            {
                '';
                var __r4 = __$ctx._inputId;
                __$ctx._inputId = _$s8id;
                var __r5 = __$ctx._labelId;
                __$ctx._labelId = 'label' + _$s8id;
                var __r6 = __$ctx._hintId;
                __$ctx._hintId = 'hint' + _$s8id;
                var __r7 = __$ctx._name;
                __$ctx._name = __$ctx.ctx.name || '';
                var __r8 = __$ctx._value;
                __$ctx._value = _$s8value;
    ...
    function $84(__$ctx) {
        if (!(__$ctx['__$anflg60'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$s5c = ('', __r0 = __$ctx['__$anflg60'], __$ctx['__$anflg60'] = true, __r1 = $84(__$ctx), __$ctx['__$anflg60'] = __r0, '', __r1);
                _$s5c += [
    ...
    function $110(__$ctx) {
        ...
        var _$s1_this = __$ctx['i-global'], _$s1js = {}, _$s1block = {
                block: 'i-global',
                js: _$s1js
            }, _$s1e;
        for (_$s1e in _$s1_this) {
            if (_$s1_this.hasOwnProperty(_$s1e) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$s1e, __r3 = $116(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
                _$s1js[_$s1e] = _$s1_this[_$s1e];
            } else {
                undefined;
            }
        }
    ...
    function $145(__$ctx) {
        var _$rpparams = __$ctx.ctx.params || {}, _$rpiGlobal = __$ctx['i-global'], _$rpisTldChanged = _$rpparams.tld && _$rpparams.tld !== _$rpiGlobal.tld, _$rptld, _$rpxYaDomain, _$rpyaDomain;
        if (_$rpisTldChanged) {
            _$rptld = _$rpparams.tld;
            _$rpxYaDomain = _$rptld === 'tr' ? 'yandex.com.tr' : 'yandex.' + _$rptld;
            _$rpyaDomain = [
                'ua',
                'by',
                'kz'
            ].indexOf(_$rptld) != -1 ? 'yandex.ru' : _$rpxYaDomain;
            _$rpiGlobal['content-region'] = _$rptld;
            _$rpiGlobal['click-host'] = '//clck.' + _$rpyaDomain;
            _$rpiGlobal['passport-host'] = 'https://passport.' + _$rpyaDomain;
            _$rpiGlobal['pass-host'] = '//pass.' + _$rpxYaDomain;
            _$rpiGlobal['social-host'] = '//social.' + _$rpxYaDomain;
            _$rpiGlobal['export-host'] = '//export.' + _$rpxYaDomain;
        } else {
            undefined;
        }
        for (var _$rpp in _$rpparams) {
            _$rpiGlobal[_$rpp] = _$rpparams[_$rpp];
        }
        return;
    }
    function $148(__$ctx) {
    ...
    function $158(__$ctx) {
        ...
        while (_$rne = _$rnes.shift()) {
            _$rnps[_$rne] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$rne, __r3 = $121(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$rnps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $148(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $181(__$ctx) {
        ...
        if (!cache || !__$ctx._cacheLog) {
            return _$refollow.call(__$ctx);
        } else {
            undefined;
        }
        var _$recontents = __$ctx._buf.slice(__$ctx._cachePos).join('');
        __$ctx._cachePos = __$ctx._buf.length;
        __$ctx._cacheLog.push(_$recontents, {
            log: __$ctx._localLog.slice(),
            link: __$ctx.ctx.link
        });
        var _$reres = _$refollow.call(__$ctx);
        __$ctx._cachePos = __$ctx._buf.length;
        return _$reres;
        return;
    }
    ...
    function $190(__$ctx) {
        var _$rdcached;
        function _$rdsetProperty(obj, key, value) {
            if (key.length === 0) {
                return undefined;
            } else {
                undefined;
        ...
        if (_$rdcached = cache.get(__$ctx.ctx.cache)) {
            var _$rdoldLinks = __$ctx._links;
            if (__$ctx.ctx.links) {
                __$ctx._links = __$ctx.ctx.links;
            } else {
                undefined;
            }
            for (var _$rdi = 0; _$rdi < _$rdcached.log.length; _$rdi++) {
                if (typeof _$rdcached.log[_$rdi] === 'string') {
                    __$ctx._buf.push(_$rdcached.log[_$rdi]);
                    continue;
                } else {
                    undefined;
                }
                var _$rdlog = _$rdcached.log[_$rdi], _$rdreverseLog;
                _$rdreverseLog = _$rdlog.log.map(function (entry) {
                    return {
                        key: entry[0],
                        value: _$rdsetProperty(this, entry[0], entry[1])
                    };
                }, __$ctx).reverse();
                {
                    '';
                ...
                undefined;
                _$rdreverseLog.forEach(function (entry) {
                    _$rdsetProperty(this, entry.key, entry.value);
                }, __$ctx);
            }
            __$ctx._links = _$rdoldLinks;
            return _$rdcached.res;
        } else {
            undefined;
        }
        var _$rdcacheLog = [], _$rdres;
        {
            '';
            ...
            __$ctx._cacheLog = _$rdcacheLog;
            var __r9 = __$ctx._localLog;
            __$ctx._localLog = [];
            {
                _$rdres = $1(__$ctx);
                var _$rdtail = __$ctx._buf.slice(__$ctx._cachePos).join('');
                if (_$rdtail) {
                    _$rdcacheLog.push(_$rdtail);
                } else {
                    undefined;
                }
            }
    ...
    function $195(__$ctx) {
        ...
        if (__t === 'default') {
            ...
            if (!__$ctx._.isSimple(__$ctx.ctx) === false) {
                __$ctx._listLength--;
                var _$rbctx = __$ctx.ctx;
                (_$rbctx && _$rbctx !== true || _$rbctx === 0) && __$ctx._buf.push(_$rbctx);
                return;
            } else {
                if (!!__$ctx.ctx === false) {
                    __$ctx._listLength--;
    ...
    function $197(__$ctx) {
        ...
        var _$rcBEM_ = __$ctx.BEM, _$rcv = __$ctx.ctx, _$rcbuf = __$ctx._buf, _$rctag;
        _$rctag = ('', __r0 = $$mode, $$mode = 'tag', __r1 = $1(__$ctx), $$mode = __r0, '', __r1);
        typeof _$rctag != 'undefined' || (_$rctag = _$rcv.tag);
        typeof _$rctag != 'undefined' || (_$rctag = 'div');
        if (_$rctag) {
            var _$rcjsParams, _$rcjs;
            if ($$block && _$rcv.js !== false) {
                _$rcjs = ('', __r4 = $$mode, $$mode = 'js', __r5 = $1(__$ctx), $$mode = __r4, '', __r5);
                _$rcjs = _$rcjs ? __$ctx._.extend(_$rcv.js, _$rcjs === true ? {} : _$rcjs) : _$rcv.js === true ? {} : _$rcv.js;
                _$rcjs && ((_$rcjsParams = {})[_$rcBEM_.INTERNAL.buildClass($$block, _$rcv.elem)] = _$rcjs);
            } else {
                undefined;
            }
            _$rcbuf.push('<', _$rctag);
            var _$rcisBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $1(__$ctx), $$mode = __r6, '', __r7);
            typeof _$rcisBEM != 'undefined' || (_$rcisBEM = typeof _$rcv.bem != 'undefined' ? _$rcv.bem : _$rcv.block || _$rcv.elem);
            var _$rccls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $1(__$ctx), $$mode = __r8, '', __r9);
            _$rccls || (_$rccls = _$rcv.cls);
            var _$rcaddJSInitClass = _$rcv.block && _$rcjsParams;
            if (_$rcisBEM || _$rccls) {
                _$rcbuf.push(' class="');
                if (_$rcisBEM) {
                    _$rcBEM_.INTERNAL.buildClasses($$block, _$rcv.elem, _$rcv.elemMods || _$rcv.mods, _$rcbuf);
                    var _$rcmix = ('', __r10 = $$mode, $$mode = 'mix', __r11 = $1(__$ctx), $$mode = __r10, '', __r11);
                    _$rcv.mix && (_$rcmix = _$rcmix ? _$rcmix.concat(_$rcv.mix) : _$rcv.mix);
                    if (_$rcmix) {
                        var _$rcvisited = {};
                        function _$rcvisitedKey(block, elem) {
                            return (block || '') + '__' + (elem || '');
                        }
                        _$rcvisited[_$rcvisitedKey($$block, $$elem)] = true;
                        if (!__$ctx._.isArray(_$rcmix)) {
                            _$rcmix = [_$rcmix];
                        } else {
                            undefined;
                        }
                        for (var _$rci = 0; _$rci < _$rcmix.length; _$rci++) {
                            var _$rcmixItem = _$rcmix[_$rci];
                            if (!_$rcmixItem) {
                                continue;
                            } else {
                                undefined;
                            }
                            var _$rchasItem = _$rcmixItem.block || _$rcmixItem.elem, _$rcblock = _$rcmixItem.block || _$rcmixItem._block || $$block, _$rcelem = _$rcmixItem.elem || _$rcmixItem._elem || $$elem, _$rcmods = _$rcmixItem.mods || $$mods, _$rcelemMods = _$rcmixItem.elemMods || {};
                            _$rchasItem && _$rcbuf.push(' ');
                            _$rcBEM_.INTERNAL[_$rchasItem ? 'buildClasses' : 'buildModsClasses'](_$rcblock, _$rcmixItem.elem || _$rcmixItem._elem || (_$rcmixItem.block ? undefined : $$elem), _$rcmixItem.elemMods || _$rcmixItem.mods, _$rcbuf);
                            if (_$rcmixItem.js) {
                                (_$rcjsParams || (_$rcjsParams = {}))[_$rcBEM_.INTERNAL.buildClass(_$rcblock, _$rcmixItem.elem)] = _$rcmixItem.js === true ? {} : _$rcmixItem.js;
                                _$rcaddJSInitClass || (_$rcaddJSInitClass = _$rcblock && !_$rcmixItem.elem);
                            } else {
                                undefined;
                            }
                            if (_$rchasItem && !_$rcvisited[_$rcvisitedKey(_$rcblock, _$rcelem)]) {
                                _$rcvisited[_$rcvisitedKey(_$rcblock, _$rcelem)] = true;
                                var _$rcnestedMix = ('', __r12 = $$block, $$block = _$rcblock, __r13 = $$elem, $$elem = _$rcelem, __r14 = $$mods, $$mods = _$rcmods, __r15 = $$elemMods, $$elemMods = _$rcelemMods, __r16 = $$mode, $$mode = 'mix', __r17 = $1(__$ctx), $$block = __r12, $$elem = __r13, $$mods = __r14, $$elemMods = __r15, $$mode = __r16, '', __r17);
                                if (_$rcnestedMix) {
                                    for (var _$rcj = 0; _$rcj < _$rcnestedMix.length; _$rcj++) {
                                        var _$rcnestedItem = _$rcnestedMix[_$rcj];
                                        if (!_$rcnestedItem.block && !_$rcnestedItem.elem || !_$rcvisited[_$rcvisitedKey(_$rcnestedItem.block, _$rcnestedItem.elem)]) {
                                            _$rcnestedItem._block = _$rcblock;
                                            _$rcnestedItem._elem = _$rcelem;
                                            _$rcmix.splice(_$rci + 1, 0, _$rcnestedItem);
                                        } else {
                                            undefined;
                                        }
                                    }
                ...
                _$rccls && _$rcbuf.push(_$rcisBEM ? ' ' : '', _$rccls);
                _$rcaddJSInitClass && _$rcbuf.push(' i-bem');
                _$rcbuf.push('"');
            } else {
                undefined;
            }
            if (_$rcjsParams) {
                var _$rcjsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $1(__$ctx), $$mode = __r20, '', __r21);
                _$rcbuf.push(' ', _$rcjsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$rcjsParams)), '"');
            } else {
                undefined;
            }
            var _$rcattrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $1(__$ctx), $$mode = __r22, '', __r23);
            _$rcattrs = __$ctx._.extend(_$rcattrs, _$rcv.attrs);
            if (_$rcattrs) {
                var _$rcname;
                for (_$rcname in _$rcattrs) {
                    if (_$rcattrs[_$rcname] === undefined) {
                        continue;
                    } else {
                        undefined;
                    }
                    _$rcbuf.push(' ', _$rcname, '="', __$ctx._.attrEscape(_$rcattrs[_$rcname]), '"');
                }
            } else {
                undefined;
            }
        ...
        if (__$ctx._.isShortTag(_$rctag)) {
            _$rcbuf.push('/>');
        } else {
            _$rctag && _$rcbuf.push('>');
            var _$rccontent = ('', __r24 = $$mode, $$mode = 'content', __r25 = $1(__$ctx), $$mode = __r24, '', __r25);
            if (_$rccontent || _$rccontent === 0) {
                var _$rcisBEM = $$block || $$elem;
                {
                    '';
                    var __r26 = __$ctx._notNewList;
                    __$ctx._notNewList = false;
                    var __r27 = __$ctx.position;
                    __$ctx.position = _$rcisBEM ? 1 : __$ctx.position;
                    var __r28 = __$ctx._listLength;
                    __$ctx._listLength = _$rcisBEM ? 1 : __$ctx._listLength;
                    var __r29 = __$ctx.ctx;
                    __$ctx.ctx = _$rccontent;
                    var __r30 = $$mode;
                    $$mode = '';
                    $1(__$ctx);
            ...
            _$rctag && _$rcbuf.push('</', _$rctag, '>');
        }
        return;
    }
    function $206(__$ctx) {
        var _$r9v = __$ctx.ctx, _$r9l = _$r9v.length, _$r9i = 0, _$r9prevPos = __$ctx.position, _$r9prevNotNewList = __$ctx._notNewList;
        if (_$r9prevNotNewList) {
            __$ctx._listLength += _$r9l - 1;
        } else {
            __$ctx.position = 0;
            __$ctx._listLength = _$r9l;
        }
        __$ctx._notNewList = true;
        while (_$r9i < _$r9l) {
            var _$r9newCtx = _$r9v[_$r9i++];
            {
                '';
                var __r0 = __$ctx.ctx;
                __$ctx.ctx = _$r9newCtx == null ? '' : _$r9newCtx;
                $1(__$ctx);
                __$ctx.ctx = __r0;
                '';
            }
        ...
        _$r9prevNotNewList || (__$ctx.position = _$r9prevPos);
        return;
    }
    function $209(__$ctx) {
        var _$r8vBlock = __$ctx.ctx.block, _$r8vElem = __$ctx.ctx.elem, _$r8block = __$ctx._currBlock || $$block;
        __$ctx.ctx || (__$ctx.ctx = {});
        {
            ...
            var __r2 = $$block;
            $$block = _$r8vBlock || (_$r8vElem ? _$r8block : undefined);
            var __r3 = __$ctx._currBlock;
            __$ctx._currBlock = _$r8vBlock || _$r8vElem ? undefined : _$r8block;
            var __r4 = $$elem;
            $$elem = __$ctx.ctx.elem;
            var __r5 = $$mods;
            $$mods = (_$r8vBlock ? __$ctx.ctx.mods : $$mods) || {};
            var __r6 = $$elemMods;
