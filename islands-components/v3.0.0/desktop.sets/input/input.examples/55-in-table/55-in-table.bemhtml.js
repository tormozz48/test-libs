var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $419(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg10'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg9'], __$ctx['__$anflg9'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $419(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg9'] = __r0, '', __r4;
        return;
    }
    function $15(__$ctx) {
        if ($$elem === 'core') {
    ...
    function $18(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $419(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg2'] = __r0, '', __r4;
        return;
    }
    function $40(__$ctx) {
        if (!($$mods && $$mods.pseudo === 'yes') === false) {
            if (!!$$elem === false) {
                if (!!__$ctx.ctx.url === false) {
                    var _$2xdisabled = (__$ctx.ctx.mods || {}).disabled === 'yes', _$2xa = {
                            role: 'button',
                            tabindex: 0
                        };
                    if (_$2xdisabled) {
                        _$2xa['aria-disabled'] = true;
                        delete _$2xa.tabindex;
                    } else {
                        undefined;
                    }
                    return _$2xa;
    ...
    function $49(__$ctx) {
        if (!(__$ctx['__$anflg7'] !== true) === false) {
            if (!($$mods && $$mods.disabled === 'yes') === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$2oattrs = ('', __r0 = __$ctx['__$anflg7'], __$ctx['__$anflg7'] = true, __r1 = $40(__$ctx), __$ctx['__$anflg7'] = __r0, '', __r1) || {};
                    _$2oattrs.tabindex = -1;
                    _$2oattrs['aria-disabled'] = true;
                    return _$2oattrs;
                    return;
                } else {
                    return $58(__$ctx);
    ...
    function $60(__$ctx) {
        var _$2nctx = __$ctx.ctx, _$2nattrs = {};
        [
            'title',
            'target',
            'id',
            ...
            if (_$2nctx.hasOwnProperty(param)) {
                _$2nattrs[param] = String(_$2nctx[param]);
            } else {
                undefined;
            }
        });
        if (_$2nctx.url !== null && typeof _$2nctx.url !== 'undefined') {
            if (__$ctx.isSimple(_$2nctx.url)) {
                _$2nattrs.href = String(_$2nctx.url);
            } else {
                var _$2nbuf = [];
                {
                    '';
                ...
                undefined;
                _$2nattrs.href = _$2nbuf.join('');
            }
        } else {
            _$2nattrs.role = 'button';
            if (!_$2nattrs.tabindex) {
                _$2nattrs.tabindex = '0';
            } else {
                undefined;
            }
        }
    ...
    function $113(__$ctx) {
        if (!!__$ctx._baseAttrsApplyed === false) {
            var __r0, __r1, __r2;
            var _$2ua = ('', __r0 = __$ctx._value, __$ctx._value = null, __r1 = __$ctx._baseAttrsApplyed, __$ctx._baseAttrsApplyed = true, __r2 = $113(__$ctx), __$ctx._value = __r0, __$ctx._baseAttrsApplyed = __r1, '', __r2);
            return __$ctx._.extend(_$2ua, {
                rows: 10,
                cols: 10
            });
            return;
    ...
    function $172(__$ctx) {
        var __r0, __r4, __r1, __r2, __r3;
        var _$2sctx = __$ctx.ctx, _$2selemMods = _$2sctx.elemMods || (_$2sctx.elemMods = {});
        _$2selemMods.visibility = 'visible';
        return '', __r0 = __$ctx['__$anflg8'], __$ctx['__$anflg8'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = _$2sctx, __r2 = $$mode, $$mode = '', __r3 = $419(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg8'] = __r0, '', __r4;
        return;
    }
    function $182(__$ctx) {
        {
    ...
    function $190(__$ctx) {
        var __r0, __r1, __r2;
        var _$1wvalue = ('', __r0 = $$mode, $$mode = 'value', __r1 = __$ctx.ctx, __$ctx.ctx = __$ctx.ctx.value, __r2 = $200(__$ctx), $$mode = __r0, __$ctx.ctx = __r1, '', __r2), _$1wid = __$ctx.ctx.id || __$ctx.generateId(), _$1wmods = __$ctx.ctx.mods || {};
    ...
    function $297(__$ctx) {
        ...
        var _$12ctx = __$ctx.ctx, _$12dtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $336(__$ctx), $$mode = __r0, '', __r1), _$12xUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $304(__$ctx), $$mode = __r2, '', __r3), _$12buf = [
                _$12dtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $310(__$ctx) {
        ...
        var _$1kmix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $307(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1kjsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $341(__$ctx), $$mode = __r3, '', __r4);
    ...
    function $313(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1gmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $307(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1gmix.push({
                    block: 'i-ua',
    ...
    function $341(__$ctx) {
        ...
        for (_$te in _$t_this) {
            if (_$t_this.hasOwnProperty(_$te) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$te, __r3 = $379(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $349(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $419(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $355(__$ctx) {
        if (!(__$ctx['__$anflg1'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$xc = ('', __r0 = __$ctx['__$anflg1'], __$ctx['__$anflg1'] = true, __r1 = $355(__$ctx), __$ctx['__$anflg1'] = __r0, '', __r1);
                _$xc += [
    ...
    function $421(__$ctx) {
        ...
        while (_$fe = _$fes.shift()) {
            _$fps[_$fe] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$fe, __r3 = $384(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$fps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $411(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
