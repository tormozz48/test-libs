var BEMHTML = function() {
  ...
  var cache,
        ...
        if (__t === 'input') {
            ...
            if (__t === 'content') {
                ...
                if (__t === 'clear') {
                    ...
                    var _$v9a = __$ctx._.extend({
                            id: __$ctx._inputId,
                            name: __$ctx._name
                        }, __$ctx.ctx.controlAttrs);
                    (__$ctx._value || __$ctx._value === 0) && (_$v9a.value = __$ctx._value);
                    $$mods.disabled && (_$v9a.disabled = 'disabled');
                    _$v9a['aria-labelledby'] = __$ctx._labelId + ' ' + __$ctx._hintId;
                    return _$v9a;
                    return;
                } else {
                    return $155(__$ctx);
    ...
    function $34(__$ctx) {
        if ($$elem === 'control') {
            if (!(__$ctx['__$anflg68'] !== true) === false) {
                if (!!$$mods.clear === false) {
                    return $38(__$ctx);
                } else {
                    return $43(__$ctx);
    ...
    function $38(__$ctx) {
        {
            '';
            var __r0 = __$ctx['__$anflg68'];
            __$ctx['__$anflg68'] = true;
            {
                '';
                var __r1 = __$ctx.ctx;
                __$ctx.ctx = {
    ...
    function $43(__$ctx) {
        if (!(__$ctx['__$anflg67'] !== true) === false) {
            if (!!$$elem === false) {
                return $46(__$ctx);
            } else {
                return $155(__$ctx);
    ...
    function $46(__$ctx) {
        var __r0, __r1, __r2;
        var _$v0value = ('', __r0 = $$mode, $$mode = 'value', __r1 = __$ctx.ctx, __$ctx.ctx = __$ctx.ctx.value, __r2 = $56(__$ctx), $$mode = __r0, __$ctx.ctx = __r1, '', __r2), _$v0id = __$ctx.ctx.id || __$ctx.generateId(), _$v0mods = __$ctx.ctx.mods || {};
        _$v0mods.theme = _$v0mods.theme || 'normal';
        {
            '';
            var __r3 = __$ctx['__$anflg67'];
            __$ctx['__$anflg67'] = true;
            {
                '';
                var __r4 = __$ctx._inputId;
                __$ctx._inputId = _$v0id;
                var __r5 = __$ctx._labelId;
                __$ctx._labelId = 'label' + _$v0id;
                var __r6 = __$ctx._hintId;
                __$ctx._hintId = 'hint' + _$v0id;
                var __r7 = __$ctx._name;
                __$ctx._name = __$ctx.ctx.name || '';
                var __r8 = __$ctx._value;
                __$ctx._value = _$v0value;
    ...
    function $84(__$ctx) {
        if (!(__$ctx['__$anflg66'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$uxc = ('', __r0 = __$ctx['__$anflg66'], __$ctx['__$anflg66'] = true, __r1 = $84(__$ctx), __$ctx['__$anflg66'] = __r0, '', __r1);
                _$uxc += [
    ...
    function $110(__$ctx) {
        ...
        var _$ut_this = __$ctx['i-global'], _$utjs = {}, _$utblock = {
                block: 'i-global',
                js: _$utjs
            }, _$ute;
        for (_$ute in _$ut_this) {
            if (_$ut_this.hasOwnProperty(_$ute) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ute, __r3 = $116(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
                _$utjs[_$ute] = _$ut_this[_$ute];
            } else {
                undefined;
            }
        }
    ...
    function $145(__$ctx) {
        var _$uhparams = __$ctx.ctx.params || {}, _$uhiGlobal = __$ctx['i-global'], _$uhisTldChanged = _$uhparams.tld && _$uhparams.tld !== _$uhiGlobal.tld, _$uhtld, _$uhxYaDomain, _$uhyaDomain;
        if (_$uhisTldChanged) {
            _$uhtld = _$uhparams.tld;
            _$uhxYaDomain = _$uhtld === 'tr' ? 'yandex.com.tr' : 'yandex.' + _$uhtld;
            _$uhyaDomain = [
                'ua',
                'by',
                'kz'
            ].indexOf(_$uhtld) != -1 ? 'yandex.ru' : _$uhxYaDomain;
            _$uhiGlobal['content-region'] = _$uhtld;
            _$uhiGlobal['click-host'] = '//clck.' + _$uhyaDomain;
            _$uhiGlobal['passport-host'] = 'https://passport.' + _$uhyaDomain;
            _$uhiGlobal['pass-host'] = '//pass.' + _$uhxYaDomain;
            _$uhiGlobal['social-host'] = '//social.' + _$uhxYaDomain;
            _$uhiGlobal['export-host'] = '//export.' + _$uhxYaDomain;
        } else {
            undefined;
        }
        for (var _$uhp in _$uhparams) {
            _$uhiGlobal[_$uhp] = _$uhparams[_$uhp];
        }
        return;
    }
    function $148(__$ctx) {
    ...
    function $158(__$ctx) {
        ...
        while (_$ufe = _$ufes.shift()) {
            _$ufps[_$ufe] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$ufe, __r3 = $121(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
        __$ctx['i-global'] = __$ctx._.extend(_$ufps, ('', __r4 = $$mode, $$mode = 'env', __r5 = $$block, $$block = 'i-global', __r6 = $148(__$ctx), $$mode = __r4, $$block = __r5, '', __r6));
        applyc(__$ctx);
        undefined;
        return;
    }
    ...
    function $181(__$ctx) {
        ...
        if (!cache || !__$ctx._cacheLog) {
            return _$u6follow.call(__$ctx);
        } else {
            undefined;
        }
        var _$u6contents = __$ctx._buf.slice(__$ctx._cachePos).join('');
        __$ctx._cachePos = __$ctx._buf.length;
        __$ctx._cacheLog.push(_$u6contents, {
            log: __$ctx._localLog.slice(),
            link: __$ctx.ctx.link
        });
        var _$u6res = _$u6follow.call(__$ctx);
        __$ctx._cachePos = __$ctx._buf.length;
        return _$u6res;
        return;
    }
    ...
    function $190(__$ctx) {
        var _$u5cached;
        function _$u5setProperty(obj, key, value) {
            if (key.length === 0) {
                return undefined;
            } else {
                undefined;
        ...
        if (_$u5cached = cache.get(__$ctx.ctx.cache)) {
            var _$u5oldLinks = __$ctx._links;
            if (__$ctx.ctx.links) {
                __$ctx._links = __$ctx.ctx.links;
            } else {
                undefined;
            }
            for (var _$u5i = 0; _$u5i < _$u5cached.log.length; _$u5i++) {
                if (typeof _$u5cached.log[_$u5i] === 'string') {
                    __$ctx._buf.push(_$u5cached.log[_$u5i]);
                    continue;
                } else {
                    undefined;
                }
                var _$u5log = _$u5cached.log[_$u5i], _$u5reverseLog;
                _$u5reverseLog = _$u5log.log.map(function (entry) {
                    return {
                        key: entry[0],
                        value: _$u5setProperty(this, entry[0], entry[1])
                    };
                }, __$ctx).reverse();
                {
                    '';
                ...
                undefined;
                _$u5reverseLog.forEach(function (entry) {
                    _$u5setProperty(this, entry.key, entry.value);
                }, __$ctx);
            }
            __$ctx._links = _$u5oldLinks;
            return _$u5cached.res;
        } else {
            undefined;
        }
        var _$u5cacheLog = [], _$u5res;
        {
            '';
            ...
            __$ctx._cacheLog = _$u5cacheLog;
            var __r9 = __$ctx._localLog;
            __$ctx._localLog = [];
            {
                _$u5res = $1(__$ctx);
                var _$u5tail = __$ctx._buf.slice(__$ctx._cachePos).join('');
                if (_$u5tail) {
                    _$u5cacheLog.push(_$u5tail);
                } else {
                    undefined;
                }
            }
    ...
    function $195(__$ctx) {
        ...
        if (__t === 'default') {
            ...
            if (!__$ctx._.isSimple(__$ctx.ctx) === false) {
                __$ctx._listLength--;
                var _$u3ctx = __$ctx.ctx;
                (_$u3ctx && _$u3ctx !== true || _$u3ctx === 0) && __$ctx._buf.push(_$u3ctx);
                return;
            } else {
                if (!!__$ctx.ctx === false) {
                    __$ctx._listLength--;
    ...
    function $197(__$ctx) {
        ...
        var _$u4BEM_ = __$ctx.BEM, _$u4v = __$ctx.ctx, _$u4buf = __$ctx._buf, _$u4tag;
        _$u4tag = ('', __r0 = $$mode, $$mode = 'tag', __r1 = $1(__$ctx), $$mode = __r0, '', __r1);
        typeof _$u4tag != 'undefined' || (_$u4tag = _$u4v.tag);
        typeof _$u4tag != 'undefined' || (_$u4tag = 'div');
        if (_$u4tag) {
            var _$u4jsParams, _$u4js;
            if ($$block && _$u4v.js !== false) {
                _$u4js = ('', __r4 = $$mode, $$mode = 'js', __r5 = $1(__$ctx), $$mode = __r4, '', __r5);
                _$u4js = _$u4js ? __$ctx._.extend(_$u4v.js, _$u4js === true ? {} : _$u4js) : _$u4v.js === true ? {} : _$u4v.js;
                _$u4js && ((_$u4jsParams = {})[_$u4BEM_.INTERNAL.buildClass($$block, _$u4v.elem)] = _$u4js);
            } else {
                undefined;
            }
            _$u4buf.push('<', _$u4tag);
            var _$u4isBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $1(__$ctx), $$mode = __r6, '', __r7);
            typeof _$u4isBEM != 'undefined' || (_$u4isBEM = typeof _$u4v.bem != 'undefined' ? _$u4v.bem : _$u4v.block || _$u4v.elem);
            var _$u4cls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $1(__$ctx), $$mode = __r8, '', __r9);
            _$u4cls || (_$u4cls = _$u4v.cls);
            var _$u4addJSInitClass = _$u4v.block && _$u4jsParams;
            if (_$u4isBEM || _$u4cls) {
                _$u4buf.push(' class="');
                if (_$u4isBEM) {
                    _$u4BEM_.INTERNAL.buildClasses($$block, _$u4v.elem, _$u4v.elemMods || _$u4v.mods, _$u4buf);
                    var _$u4mix = ('', __r10 = $$mode, $$mode = 'mix', __r11 = $1(__$ctx), $$mode = __r10, '', __r11);
                    _$u4v.mix && (_$u4mix = _$u4mix ? _$u4mix.concat(_$u4v.mix) : _$u4v.mix);
                    if (_$u4mix) {
                        var _$u4visited = {};
                        function _$u4visitedKey(block, elem) {
                            return (block || '') + '__' + (elem || '');
                        }
                        _$u4visited[_$u4visitedKey($$block, $$elem)] = true;
                        if (!__$ctx._.isArray(_$u4mix)) {
                            _$u4mix = [_$u4mix];
                        } else {
                            undefined;
                        }
                        for (var _$u4i = 0; _$u4i < _$u4mix.length; _$u4i++) {
                            var _$u4mixItem = _$u4mix[_$u4i];
                            if (!_$u4mixItem) {
                                continue;
                            } else {
                                undefined;
                            }
                            var _$u4hasItem = _$u4mixItem.block || _$u4mixItem.elem, _$u4block = _$u4mixItem.block || _$u4mixItem._block || $$block, _$u4elem = _$u4mixItem.elem || _$u4mixItem._elem || $$elem, _$u4mods = _$u4mixItem.mods || $$mods, _$u4elemMods = _$u4mixItem.elemMods || {};
                            _$u4hasItem && _$u4buf.push(' ');
                            _$u4BEM_.INTERNAL[_$u4hasItem ? 'buildClasses' : 'buildModsClasses'](_$u4block, _$u4mixItem.elem || _$u4mixItem._elem || (_$u4mixItem.block ? undefined : $$elem), _$u4mixItem.elemMods || _$u4mixItem.mods, _$u4buf);
                            if (_$u4mixItem.js) {
                                (_$u4jsParams || (_$u4jsParams = {}))[_$u4BEM_.INTERNAL.buildClass(_$u4block, _$u4mixItem.elem)] = _$u4mixItem.js === true ? {} : _$u4mixItem.js;
                                _$u4addJSInitClass || (_$u4addJSInitClass = _$u4block && !_$u4mixItem.elem);
                            } else {
                                undefined;
                            }
                            if (_$u4hasItem && !_$u4visited[_$u4visitedKey(_$u4block, _$u4elem)]) {
                                _$u4visited[_$u4visitedKey(_$u4block, _$u4elem)] = true;
                                var _$u4nestedMix = ('', __r12 = $$block, $$block = _$u4block, __r13 = $$elem, $$elem = _$u4elem, __r14 = $$mods, $$mods = _$u4mods, __r15 = $$elemMods, $$elemMods = _$u4elemMods, __r16 = $$mode, $$mode = 'mix', __r17 = $1(__$ctx), $$block = __r12, $$elem = __r13, $$mods = __r14, $$elemMods = __r15, $$mode = __r16, '', __r17);
                                if (_$u4nestedMix) {
                                    for (var _$u4j = 0; _$u4j < _$u4nestedMix.length; _$u4j++) {
                                        var _$u4nestedItem = _$u4nestedMix[_$u4j];
                                        if (!_$u4nestedItem.block && !_$u4nestedItem.elem || !_$u4visited[_$u4visitedKey(_$u4nestedItem.block, _$u4nestedItem.elem)]) {
                                            _$u4nestedItem._block = _$u4block;
                                            _$u4nestedItem._elem = _$u4elem;
                                            _$u4mix.splice(_$u4i + 1, 0, _$u4nestedItem);
                                        } else {
                                            undefined;
                                        }
                                    }
                ...
                _$u4cls && _$u4buf.push(_$u4isBEM ? ' ' : '', _$u4cls);
                _$u4addJSInitClass && _$u4buf.push(' i-bem');
                _$u4buf.push('"');
            } else {
                undefined;
            }
            if (_$u4jsParams) {
                var _$u4jsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $1(__$ctx), $$mode = __r20, '', __r21);
                _$u4buf.push(' ', _$u4jsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$u4jsParams)), '"');
            } else {
                undefined;
            }
            var _$u4attrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $1(__$ctx), $$mode = __r22, '', __r23);
            _$u4attrs = __$ctx._.extend(_$u4attrs, _$u4v.attrs);
            if (_$u4attrs) {
                var _$u4name;
                for (_$u4name in _$u4attrs) {
                    if (_$u4attrs[_$u4name] === undefined) {
                        continue;
                    } else {
                        undefined;
                    }
                    _$u4buf.push(' ', _$u4name, '="', __$ctx._.attrEscape(_$u4attrs[_$u4name]), '"');
                }
            } else {
                undefined;
            }
        ...
        if (__$ctx._.isShortTag(_$u4tag)) {
            _$u4buf.push('/>');
        } else {
            _$u4tag && _$u4buf.push('>');
            var _$u4content = ('', __r24 = $$mode, $$mode = 'content', __r25 = $1(__$ctx), $$mode = __r24, '', __r25);
            if (_$u4content || _$u4content === 0) {
                var _$u4isBEM = $$block || $$elem;
                {
                    '';
                    var __r26 = __$ctx._notNewList;
                    __$ctx._notNewList = false;
                    var __r27 = __$ctx.position;
                    __$ctx.position = _$u4isBEM ? 1 : __$ctx.position;
                    var __r28 = __$ctx._listLength;
                    __$ctx._listLength = _$u4isBEM ? 1 : __$ctx._listLength;
                    var __r29 = __$ctx.ctx;
                    __$ctx.ctx = _$u4content;
                    var __r30 = $$mode;
                    $$mode = '';
                    $1(__$ctx);
            ...
            _$u4tag && _$u4buf.push('</', _$u4tag, '>');
        }
        return;
    }
    function $206(__$ctx) {
        var _$u1v = __$ctx.ctx, _$u1l = _$u1v.length, _$u1i = 0, _$u1prevPos = __$ctx.position, _$u1prevNotNewList = __$ctx._notNewList;
        if (_$u1prevNotNewList) {
            __$ctx._listLength += _$u1l - 1;
        } else {
            __$ctx.position = 0;
            __$ctx._listLength = _$u1l;
        }
        __$ctx._notNewList = true;
        while (_$u1i < _$u1l) {
            var _$u1newCtx = _$u1v[_$u1i++];
            {
                '';
                var __r0 = __$ctx.ctx;
                __$ctx.ctx = _$u1newCtx == null ? '' : _$u1newCtx;
                $1(__$ctx);
                __$ctx.ctx = __r0;
                '';
            }
        ...
        _$u1prevNotNewList || (__$ctx.position = _$u1prevPos);
        return;
    }
    function $209(__$ctx) {
        var _$u0vBlock = __$ctx.ctx.block, _$u0vElem = __$ctx.ctx.elem, _$u0block = __$ctx._currBlock || $$block;
        __$ctx.ctx || (__$ctx.ctx = {});
        {
            ...
            var __r2 = $$block;
            $$block = _$u0vBlock || (_$u0vElem ? _$u0block : undefined);
            var __r3 = __$ctx._currBlock;
            __$ctx._currBlock = _$u0vBlock || _$u0vElem ? undefined : _$u0block;
            var __r4 = $$elem;
            $$elem = __$ctx.ctx.elem;
            var __r5 = $$mods;
            $$mods = (_$u0vBlock ? __$ctx.ctx.mods : $$mods) || {};
            var __r6 = $$elemMods;
...
;
/* ../../../../common.blocks/input/input.examples/50-width-content.blocks/example/example.js begin */
BEM.DOM.decl('example', {

    onSetMod: {

        js: function() {
            this.width = this.domElem.width();
            this.step = 15;
        }
    ...
    /**
     * Уменьшает ширину блока на шаг
     */
    reduce: function() {
        this.width = this.width - this.step;
        this.domElem.css('width', this.width);
    },

    /**
     * Увеличивает ширину блока на шаг
     */
    increase: function() {
        this.width = this.width + this.step;
        this.domElem.css('width', this.width);
    ...
    live: function() {
        ...
        this.liveBindTo('transform', 'leftclick tap', function(e) {
            var action = this.getMod($(e.data.domElem), 'type');
            this[action]();
        });
    }
...
/* ../../../../common.blocks/input/input.examples/50-width-content.blocks/example/example.js end */
;
...
;
/* ../../../../common.blocks/input/_width/input_width_content.js begin */
(function(){

var insets = [],
    lastVisibleInset = -1;

BEM.DOM.decl({name: 'input', modName: 'width', modVal: 'content'}, {
    ...
    onSetMod: {
        ...
        js: function() {
            ...
            this.domElem.append(
                $(BEMHTML.apply({block: this.__self.getName(), elem: 'width-ruler', tag: 's'})));
            ...
            this
                ...
                .bindTo('box', 'leftclick tap', function(e) { // по клику в боксе ставим фокус на инпут
    ...
    _initShift: function() {
        ...
        this._shiftWidth = parseFloat(this.elem('width-ruler').css('paddingRight')) +
            parseFloat(this.elem('input').css('paddingLeft'));
    ...
    _setWidth: function() {
        ...
        if(lastVisibleInset >= 0) { // если в строке есть токены
            ...
            if(this._maxWidth > rulerWidth) { // если хватает места в строке для инпута
                ...
                if(insets.length > lastVisibleInset + 1 &&
                        insets[lastVisibleInset + 1].width < this._maxWidth - rulerWidth) {
    ...
    _hideLastInset: function() {
        ...
        insets[lastVisibleInset].delMod('visibility');
    ...
    _showHiddenInset: function() {
        ...
        insets[lastVisibleInset].setMod('visibility', 'visible');
    ...
    appendInset: function(html) {
        ...
        var inset = this.findBlockOn($(html), 'b-search-filter').setMod('visibility', 'visible'),
            domElem = inset.domElem,
            insetWidth;

        this.elem('box').append(domElem);

        insetWidth = Math.ceil(0.5 + domElem.outerWidth(true) +
                parseFloat(domElem.css('marginLeft')) + parseFloat(domElem.css('marginRight')));

        inset.width = insetWidth;
        inset.isVisible = true;

        insets.unshift(inset);
...
/* ../../../../common.blocks/input/_width/input_width_content.js end */
;
