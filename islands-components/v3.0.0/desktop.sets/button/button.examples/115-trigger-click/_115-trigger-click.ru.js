...
;
/* ../../../../common.blocks/button/button.examples/115-trigger-click.blocks/click-handler/click-handler.js begin */
BEM.DOM.decl('click-handler', {
    onSetMod: {
        js: {
            inited: function() {
                this._btn = this
    ...
    _click: function() {
        var counter = this._btn.elem('click-counter'),
...
/* ../../../../common.blocks/button/button.examples/115-trigger-click.blocks/click-handler/click-handler.js end */
;
...
;
/* ../../../../desktop.blocks/button/_focus/button_focus_no.js begin */
/*
 * Кнопка без возможности получения фокуса.
 * TODO: криво собирается jsdoc. Нужно переписать на  JS модификатора.
 */
BEM.DOM.decl('button', {
...
/* ../../../../desktop.blocks/button/_focus/button_focus_no.js end */
;
