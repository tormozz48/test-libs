var BEMHTML = function() {
  ...
  var cache,
    ...
    function $6(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $356(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg11'] = __r0, '', __r4;
        return;
    }
    function $9(__$ctx) {
    ...
    function $12(__$ctx) {
        ...
        return '', __r0 = __$ctx['__$anflg10'], __$ctx['__$anflg10'] = true, __r4 = ('', __r1 = __$ctx.ctx, __$ctx.ctx = {
            ...
            elem: 'js',
            url: __$ctx.ctx.url || (__$ctx.ctx.protocol ? __$ctx.ctx.protocol + ':' : '') + '//yastatic.net/jquery/' + $$mods.version + '/jquery.min.js'
        }, __r2 = $$mode, $$mode = '', __r3 = $356(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg10'] = __r0, '', __r4;
        return;
    }
    function $15(__$ctx) {
        if ($$elem === 'core') {
    ...
    function $18(__$ctx) {
        ...
        }, __r2 = $$mode, $$mode = '', __r3 = $356(__$ctx), __$ctx.ctx = __r1, $$mode = __r2, '', __r3), __$ctx['__$anflg2'] = __r0, '', __r4;
        return;
    }
    function $23(__$ctx) {
        if (!(__$ctx['__$anflg8'] !== true) === false) {
            if (!($$mods && $$mods.round === 'yes') === false) {
                if (!!$$elem === false) {
    ...
    function $28(__$ctx) {
        var __r0, __r6, __r1, __r2, __r3, __r4, __r5;
        return '', __r0 = __$ctx['__$anflg8'], __$ctx['__$anflg8'] = true, __r6 = ('', __r1 = __$ctx.ctx, __r2 = __r1.mods, __r1.mods = __$ctx.ctx.mods || {}, __r3 = __$ctx.ctx.mods, __r4 = __r3['only-icon'], __r3['only-icon'] = 'yes', __r5 = $23(__$ctx), __r1.mods = __r2, __r3['only-icon'] = __r4, '', __r5), __$ctx['__$anflg8'] = __r0, '', __r6;
        return;
    }
    function $35(__$ctx) {
    ...
    function $64(__$ctx) {
        ...
        var _$12ctx = __$ctx.ctx, _$12dtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = $327(__$ctx), $$mode = __r0, '', __r1), _$12xUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = $291(__$ctx), $$mode = __r2, '', __r3), _$12buf = [
                _$12dtype,
                {
                    elem: 'root',
                    content: [
    ...
    function $71(__$ctx) {
        ...
        if (_$zctx.content) {
            var _$zcnt;
            _$zparams.content = (_$zcnt = [], '', __r0 = __$ctx._buf, __$ctx._buf = _$zcnt, __r1 = $$mode, $$mode = '', __r2 = __$ctx.ctx, __$ctx.ctx = _$zctx.content, __r3 = $356(__$ctx), __$ctx._buf = __r0, $$mode = __r1, __$ctx.ctx = __r2, '', __r3, _$zcnt.join(''));
        } else {
            undefined;
        }
    ...
    function $104(__$ctx) {
        if (!(__$ctx['__$anflg9'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$2actx = __$ctx.ctx, _$2aattrs = ('', __r0 = __$ctx['__$anflg9'], __$ctx['__$anflg9'] = true, __r1 = $104(__$ctx), __$ctx['__$anflg9'] = __r0, '', __r1) || {}, _$2adefaults = {};
                (_$2actx.attrs || {}).action != null && (_$2adefaults.method = 'post');
                return __$ctx._.extend(_$2adefaults, _$2aattrs);
                return;
            } else {
                return $163(__$ctx);
            }
    ...
    function $117(__$ctx) {
        if (!(__$ctx['__$anflg7'] !== true) === false) {
            if (!__$ctx.ctx.url === false) {
                if (!!$$elem === false) {
                    var __r0, __r1;
                    var _$20ctx = __$ctx.ctx, _$20p = ('', __r0 = __$ctx['__$anflg7'], __$ctx['__$anflg7'] = true, __r1 = $117(__$ctx), __$ctx['__$anflg7'] = __r0, '', __r1), _$20a = { href: _$20ctx.url };
    ...
    function $130(__$ctx) {
        var __r0, __r1;
        var _$1zctx = __$ctx.ctx, _$1zp = ('', __r0 = __$ctx['__$anflg6'], __$ctx['__$anflg6'] = true, __r1 = $117(__$ctx), __$ctx['__$anflg6'] = __r0, '', __r1), _$1za = { type: _$1zctx.type || 'button' }, _$1zprops = [
                'name',
                'value'
            ], _$1zi;
    ...
    function $252(__$ctx) {
        if (!(__$ctx['__$anflg1'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$xc = ('', __r0 = __$ctx['__$anflg1'], __$ctx['__$anflg1'] = true, __r1 = $252(__$ctx), __$ctx['__$anflg1'] = __r0, '', __r1);
                _$xc += [
    ...
    function $300(__$ctx) {
        ...
        var _$1kmix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = $297(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1kjsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = $335(__$ctx), $$mode = __r3, '', __r4);
    ...
    function $303(__$ctx) {
        if (!(__$ctx['__$anflg4'] !== true) === false) {
            if (!!$$elem === false) {
                var __r0, __r1;
                var _$1gmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = $297(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1gmix.push({
                    block: 'i-ua',
    ...
    function $335(__$ctx) {
        ...
        for (_$te in _$t_this) {
            if (_$t_this.hasOwnProperty(_$te) && ('', __r0 = $$mode, $$mode = 'public-params', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$te, __r3 = $341(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3)) {
    ...
    function $358(__$ctx) {
        ...
        while (_$fe = _$fes.shift()) {
            _$fps[_$fe] = ('', __r0 = $$mode, $$mode = 'default', __r1 = $$block, $$block = 'i-global', __r2 = $$elem, $$elem = _$fe, __r3 = $74(__$ctx), $$mode = __r0, $$block = __r1, $$elem = __r2, '', __r3);
        }
    ...
    function $383(__$ctx) {
        ...
        if (_$4tag) {
            ...
            _$4buf.push('<', _$4tag);
            var _$4isBEM = ('', __r6 = $$mode, $$mode = 'bem', __r7 = $265(__$ctx), $$mode = __r6, '', __r7);
            typeof _$4isBEM != 'undefined' || (_$4isBEM = typeof _$4v.bem != 'undefined' ? _$4v.bem : _$4v.block || _$4v.elem);
            var _$4cls = ('', __r8 = $$mode, $$mode = 'cls', __r9 = $316(__$ctx), $$mode = __r8, '', __r9);
            ...
            if (_$4jsParams) {
                var _$4jsAttr = ('', __r20 = $$mode, $$mode = 'jsAttr', __r21 = $362(__$ctx), $$mode = __r20, '', __r21);
                _$4buf.push(' ', _$4jsAttr || 'data-bem', '="', __$ctx._.attrEscape(JSON.stringify(_$4jsParams)), '"');
            } else {
                undefined;
            }
            var _$4attrs = ('', __r22 = $$mode, $$mode = 'attrs', __r23 = $103(__$ctx), $$mode = __r22, '', __r23);
        ...
        if (__$ctx._.isShortTag(_$4tag)) {
            ...
            _$4tag && _$4buf.push('>');
            var _$4content = ('', __r24 = $$mode, $$mode = 'content', __r25 = $229(__$ctx), $$mode = __r24, '', __r25);
